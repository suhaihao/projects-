						...
						<div class="panel panel-default">
							...
							<form id="myfrom" action="${path}info/ind.do" method="post"
								...
								<div id="body" class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="xzqh" name="XZQHMC"
												...
												placeholder="请选择行政区划" onfocus="this.blur()"
												readonly="readonly">（点击选择） <input type="hidden"
										...
										<div class="col-md-9">
											<jf:if test="${DDJ01.ZT==0}">
												<input type="text" id="text-input" name="ZT"
													class="form-control" value="退出" readonly="readonly">
											</jf:if>
									...
									<div class="form-group">
										<label class="col-md-3 control-label">退出说明</label>
										<div class="col-md-9">
											<textarea id="textarea-input" name="BZ" rows="3"
												class="form-control" placeholder="说点什么。。。"
										...
										<div id="${list_d.FWNRLB}" class="form-group">
											...
											<div class="col-md-9">
												<textarea id="textarea-input" name="sm${list_d.FWNRLB}"
													rows="3" class="form-control" placeholder="说点什么。。。"
