...
<body>
	<%
		request.setAttribute("dDJ01_JL", request.getAttribute("dDJ01_JL"));
	%>
	<!-- start: Header -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>奖励修改</strong>
								</h2>
							</div>
							<form id="myfrom" action="${path}jl/update.do" method="post"
								class="form-horizontal">
								<div id="body" class="panel-body">
									<input type="hidden" id="JFID" name="JFID"
										value="${dDJ01_JL.JFID}"> <input type="hidden" id="ZT"
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="text" id="DDJ01_MCN" name="DDJ01_MC"
												...
												value="${dDJ01_JL.DDJ01_MC}" readonly="readonly"> <input
												type="hidden" id="DDJ01_JFIDN" name="DDJ01_JFID"
												value="${dDJ01_JL.DDJ01_JFID}" />
										</div>
										<div class="col-md-2">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text"  name="JL"
												class="form-control" placeholder="请输入奖励名称"
												value="${dDJ01_JL.JL}">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="textarea-input" name="JL_SM" rows="9"
												class="form-control" placeholder="说点什么。。。">${dDJ01_JL.JL_SM}</textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control"
												value="${dDJ01_JL.LRRY}" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control"
												value="<fmt:formatDate value="${dDJ01_JL.LRRQ}" pattern="yyyy-MM-dd HH:mm:ss" />"
												readonly="readonly">
										</div>
									</div>
									<div class="modal-footer">
										...
										<a class="btn btn-danger" href="${path}jl/sel.do"> <i
