					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>技术咨询查看</strong>
								</h2>
							...
							<form id="myfrom" action="${path}/jszx/update.do" method="post"
								...
								<div class="panel-body">
									<div class="form-group">
										<label class="col-md-3 control-label">咨询时间 <i
											style="color: red">*</i>
										</label>
										<div class="col-md-9">
											<input type="text" name="BT" class="form-control"
												placeholder="请输入标题"
												value="<fmt:formatDate value="${dFW23.LRRQ}"
														pattern="yyyy-MM-dd HH:mm:ss" />"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">咨询人员 <i
											style="color: red">*</i>
										</label>
										<div class="col-md-9">
											<input type="text" name="BT" class="form-control"
												placeholder="请输入标题" value="${dFW23.LRRYMC}"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="BT" class="form-control"
												placeholder="请输入标题" value="${dFW23.BT}" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="textarea-input" name="NR" rows="9"
												...
												readonly="readonly">${dFW23.NR}</textarea>
										</div>
									</div>
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<jf:if test="${fn:contains(fw23_fj.WJM,'jpg')==true}">
													<a href="${path}${fw23_fj.FJ}" target="_blank">${fw23_fj.WJM}</a>
												</jf:if>
									...
									<div class="form-group">
										<label class="col-md-3 control-label">解答时间 <i
											style="color: red">*</i>
										</label>
										<div class="col-md-9">
											<input type="text" name="BT" class="form-control"
												placeholder="请输入标题"
												value="<fmt:formatDate value="${dFW23.JDRQ}"
														pattern="yyyy-MM-dd HH:mm:ss" />"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">解答人员 <i
											style="color: red">*</i>
										</label>
										<div class="col-md-9">
											<input type="text" name="BT" class="form-control"
												placeholder="请输入标题" value="${dFW23.JDRYMC}"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">解答内容<i
											style="color: red">*</i></label>
										<div class="col-md-9">
											<textarea id="textarea-input" name="JD" rows="9"
												class="form-control" placeholder="说点什么。。。"
												readonly="readonly">${dFW23.JD}</textarea>
										</div>
									</div>
									<br>
