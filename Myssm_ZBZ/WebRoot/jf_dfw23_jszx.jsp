										...
										<jf:forEach var="dfw23" items="${listdfw23}">
											<tr>
												<jf:if test="${dfw23.ZT==2}">
													<td style="color: red;">${dfw23.RN}</td>
												</jf:if>
												<jf:if test="${dfw23.ZT!=2}">
													<td>${dfw23.RN}</td>
												</jf:if>
												...
												<jf:if test="${dfw23.ZT==2}">
													<td style="color: red;"><fmt:formatDate
															value="${dfw23.LRRQ}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
												</jf:if>
												<jf:if test="${dfw23.ZT!=2}">
													<td>${dfw23.DDJ01_MC}</td>
												</jf:if>
												<jf:if test="${dfw23.ZT==2}">
													<td style="color: red;">${dfw23.DDJ01_MC}</td>
												</jf:if>
												<jf:if test="${dfw23.ZT!=2}">
													<td>${dfw23.BT}</td>
												</jf:if>
												<jf:if test="${dfw23.ZT==2}">
													<td style="color: red;">${dfw23.BT}</td>
												</jf:if>
												<jf:if test="${dfw23.ZT!=2}">
													<td><jf:if test="${dfw23.ZT==2}">未解答</jf:if> <jf:if
															test="${dfw23.ZT==3}">已解答</jf:if></td>
												</jf:if>
												<jf:if test="${dfw23.ZT==2}">
													<td style="color: red;"><jf:if test="${dfw23.ZT==2}">未解答</jf:if>
														<jf:if test="${dfw23.ZT==3}">已解答</jf:if></td>
												</jf:if>
