					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>奖励查看</strong>
								</h2>
								...
								<div id="body" class="panel-body">
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="text" id="DDJ01_MCN" name="DDJ01_MC"
												...
												value="${dDJ01_JL.DDJ01_MC}" readonly="readonly">
										</div>
									...
									<div class="form-group">
										<label class="col-md-3 control-label">奖励 <i
											style="color: red">*</i></label>
										<div class="col-md-9">
											<input type="text" name="DDJ01_MC"
												class="form-control"
												value="${dDJ01_JL.JL}" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="textarea-input" name="JL_SM" rows="9"
												...
												readonly="readonly">${dDJ01_JL.JL_SM}</textarea>
										</div>
									</div>
									<div class="form-group">
