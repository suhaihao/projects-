					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>评级修改</strong>
								</h2>
							</div>
										...
										<div class="col-md-9">
											<select id="select" name="PJ" class="form-control" size="1">
												...
												<jf:if test="${dDJ01_PJ.PJ==2}">
													<option value="2" selected="selected">二星</option>
												</jf:if>
												<jf:if test="${dDJ01_PJ.PJ!=2}">
												...
												<jf:if test="${dDJ01_PJ.PJ==4}">
													<option value="4" selected="selected">四星</option>
												</jf:if>
												<jf:if test="${dDJ01_PJ.PJ!=4}">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="textarea-input" name="PJ_SM" rows="9"
												class="form-control" placeholder="说点什么。。。">${dDJ01_PJ.PJ_SM}</textarea>
										</div>
									</div>
									<div class="form-group">
