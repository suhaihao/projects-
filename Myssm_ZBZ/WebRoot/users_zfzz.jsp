...
<body>
	...
	request.setAttribute("listuser",request.getAttribute("listuser"))  ;
	%>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form action="${path}info/selryxx.do" class="navbar-form"
							style="padding: 0;" method="post">
							<input type="hidden" name="DDJ01_JFID" value="${DDJ01_JFID}">
						...
						<table
							...
							<tbody>
								<jf:forEach var="lis" items="${listuser}">
									<tr>
										<td>${lis.JFNAME}</td>
										...
										<td><a class="btn btn-info" href="${path}info/yhxq.do?JFID=${lis.JFID}"> <i class="fa fa-search "></i>
										</a></td>
									</tr>
								</jf:forEach>
							</tbody>
						...
						<div style="text-align:center;">
							<ul class="pagination">
								...
								<li><a
									href="${path}/info/selryxx.do?page=1&allSize=${page.allSize}&JFNAME=${JFNAME}&DDJ01_JFID=${DDJ01_JFID}"><<</a></li>
								<li><a
									href="${path}/info/selryxx.do?page=${page.page-1}&allSize=${page.allSize}&JFNAME=${JFNAME}&DDJ01_JFID=${DDJ01_JFID}"><</a></li>
								<li class="active"><a>${page.page}</a></li>
								<li><a
									href="${path}/info/selryxx.do?page=${page.page+1}&allSize=${page.allSize}&JFNAME=${JFNAME}&DDJ01_JFID=${DDJ01_JFID}">></a></li>
								<li><a
									href="${path}/info/selryxx.do?page=${page.totalPage}&allSize=${page.allSize}&JFNAME=${JFNAME}&DDJ01_JFID=${DDJ01_JFID}">>></a></li>
								<li><a href="javascript:void(0);"
									onclick="xztz(this,'${page.allSize}','${path}','&JFNAME=${JFNAME}&DDJ01_JFID=${DDJ01_JFID}')">点击选择跳转</a></li>
							</ul>
						</div>
						<!--分页结束 -->
					</div>
