...
<link href="${path}/assets/plugins/xcharts/css/xcharts.min.css"
	rel=" stylesheet">
<link href="${path}/assets/plugins/fullcalendar/css/fullcalendar.css"
	rel="stylesheet">
<link href="${path}/assets/plugins/morris/css/morris.css"
	rel="stylesheet">
<link
	href="${path}/assets/plugins/jquery-ui/css/jquery-ui-1.10.4.min.css"
	rel="stylesheet">
<link
	href="${path}/assets/plugins/jvectormap/css/jquery-jvectormap-1.2.2.css"
	rel="stylesheet">
