				...
				<div class="col-md-6">
					...
					<div class="panel panel-default">
					  	<div class="panel-heading">
							<img src="${path}/assets/img/avatar.jpg" class="img-rounded">
					  	...
					  	<div class="panel-footer">												
							...
							<div class="media">
							  	<a class="pull-left" href="page-activity.html#">
							    	<img class="media-object img-rounded" src="${path}/assets/img/avatar7.jpg">
							  	</a>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
					  	...
					  	<div class="panel-footer">												
							...
							<div class="media">
							  	<a class="pull-left" href="page-activity.html#">
							    	<img class="media-object img-rounded" src="${path}/assets/img/avatar6.jpg">
							  	</a>
							  	<div class="media-body">
									<div class="pull-right small">30 minutes ago</div>
									<a href="page-activity.html#">
				...
				<div class="col-md-6">
					  	...
					  	<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-6 col-xs-12">
									<img class="img-responsive" src="${path}/assets/img/gallery/photo1.jpg">
								</div><!--/.col-->
								
								<div class="col-lg-4 col-md-6 col-xs-12">
									<img class="img-responsive" src="${path}/assets/img/gallery/photo2.jpg">
								</div><!--/.col-->
								
								<div class="col-lg-4 col-md-6 col-xs-12">
									<img class="img-responsive" src="${path}/assets/img/gallery/photo3.jpg">
								</div><!--/.col-->
					...
					<div class="panel default">
						...
						<div class="panel-footer">												
							...
							<div class="media">
							  	<a class="pull-left" href="page-activity.html#">
							    	<img class="media-object img-rounded" src="${path}/assets/img/avatar3.jpg">
							  	</a>
							  	<div class="media-body">
									<div class="pull-right small">30 minutes ago</div>
									<a href="page-activity.html#">
