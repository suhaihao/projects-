...
<body>
	<%
		...
		request.setAttribute("listddj01_pj",
				request.getAttribute("listddj01_pj"));
	%>
	<!-- start: Header -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>评级查询</strong>
								</h2>
							...
							<div class="panel-body">
								<form action="${path}pj/sel.do" class="navbar-form"
									...
									<div style="text-align: right;">
										...
										<a class="btn btn-success btn-setting" href="#"><i
											class="fa fa-search-plus "></i> 评级 </a>
									</div>
								</form>
								<table
									...
									<tbody>
										<jf:forEach var="ddj01_pj" items="${listddj01_pj}">
											<tr>
												<td>${ddj01_pj.RN}</td>
												<td><fmt:formatDate value="${ddj01_pj.LRRQ}"
														pattern="yyyy-MM-dd HH:mm:ss" /></td>
												<td>${ddj01_pj.DDJ01_MC}</td>
												...
												<td>${ddj01_pj.LRRY}</td>
												<jf:if test="${ddj01_pj.ZT==0}">
													<td><a class="btn btn-info" href="javascript:void(0);"
														onclick="tjgx('${ddj01_pj.JFID}')"> <i
															class="fa fa-edit "></i>
													</a> <a class="btn btn-danger" href="javascript:void(0);"
														onclick="deluser('${ddj01_pj.JFID}')"> <i
															class="fa fa-trash-o "></i>
													</a></td>
												</jf:if>
												<jf:if test="${ddj01_pj.ZT==1}">
													<td><a href="javascript:void(0);"
														class="btn btn-info " onclick="qxtj('${ddj01_pj.JFID}')">
															<i class="fa fa-search "></i> 查看
													</a></td>
												</jf:if>
											</tr>
											<form id="qxuser${ddj01_pj.JFID}"
												action="${path}pj/gotolabel.do" method="post">
												<input type="hidden" name="JFID" value="${ddj01_pj.JFID}" />
											</form>
											<form id="upuser${ddj01_pj.JFID}"
												action="${path}pj/gotoup.do" method="post">
												<input type="hidden" name="JFID" value="${ddj01_pj.JFID}" />
											</form>
											<form id="deluser${ddj01_pj.JFID}" action="${path}pj/del.do"
												method="post">
												<input type="hidden" name="JFID" value="${ddj01_pj.JFID}" />
											</form>
										</jf:forEach>
								...
								<div style="text-align:center;">
									<ul class="pagination">
										...
										<li><a
											href="${path}pj/sel.do?page=1&allSize=${page.allSize}&DDJ01_JFID=${DDJ01_JFID}&DDJ01_MC=${DDJ01_MC}"><<</a></li>
										<li><a
											href="${path}pj/sel.do?page=${page.page-1}&allSize=${page.allSize}&DDJ01_JFID=${DDJ01_JFID}&DDJ01_MC=${DDJ01_MC}"><</a></li>
										<li class="active"><a>${page.page}</a></li>
										<li><a
											href="${path}pj/sel.do?page=${page.page+1}&allSize=${page.allSize}&DDJ01_JFID=${DDJ01_JFID}&DDJ01_MC=${DDJ01_MC}">></a></li>
										<li><a
											href="${path}pj/sel.do?page=${page.totalPage}&allSize=${page.allSize}&DDJ01_JFID=${DDJ01_JFID}&DDJ01_MC=${DDJ01_MC}">>></a></li>
		...
		<div class="modal fade" id="myModal">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form id="myfrom" action="${path}/pj/add.do" method="post"
