					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>工单查询</strong>
								</h2>
								...
								<form action="${path}gdcx/sel.do" class="form-inline text-right"
									...
									<div class="form-group">
										<a class="btn btn-info" href="javascript:void(0);"
											onclick="jsry()"> <i class="fa fa-search"></i> 专防组织
										</a>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<a href="javascript:void(0);" class="btn btn-info "
											onclick="xzyh()"> <i class="fa fa-search "></i> 客户
										</a>
									</div>
									<div class="form-group">
...
<script type="text/javascript">
	...
	function fzfzr() {
		window.showModalDialog("/Myssm_ZBZ/order/fzfzr.do", 0,
