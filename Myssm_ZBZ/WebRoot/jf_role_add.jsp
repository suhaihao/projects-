				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-user"></i>角色添加</li>
						</ol>
					</div>
				</div>
				<!-- main -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>角色添加</strong>
								</h2>
							...
							<div class="panel-body">
								<form id="myfrom" action="${path}role/addjs.do" method="post"
									class="form-horizontal">
									<div class="form-group">
										<label class="col-md-3 control-label">角色编码 <i
											style="color: red">*</i>
										</label>
										<div class="col-md-9">
											<input type="text" name="ROLE_BM" class="form-control"
												placeholder="请输入角色编码">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">角色名称 <i
											style="color: red">*</i>
										</label>
										<div class="col-md-9">
