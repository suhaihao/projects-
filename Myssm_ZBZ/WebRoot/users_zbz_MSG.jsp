					...
					<div class="panel-body">
						<form action="${path}onlin/selZBZandRY.do" class="navbar-form"
							...
							<div style="text-align: right;">
								<label>人员分类： </label> <select id="select" name="RYFL"
						...
						<div style="text-align:center;">
							<ul class="pagination">
								...
								<li><a href="javascript:void(0);"
									onclick="xztz(this,'${page.allSize}','${path}','&XXDBLB=${XXDBLB}&JFNAME=${JFNAME}&RYFL=${RYFL}')">点击选择跳转</a></li>
							</ul>
						</div>
						<!--分页结束 -->
					</div>
