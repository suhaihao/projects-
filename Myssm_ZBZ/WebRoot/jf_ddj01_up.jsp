				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-ambulance"></i>专防组织修改</li>
						</ol>
					</div>
				</div>
				<!-- main -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>专防组织修改</strong>
								</h2>
							...
							<form id="myfrom" action="${path}info/ind.do" method="post"
								...
								<div id="body" class="panel-body">
									...
									<input type="hidden" id="DSYS01_JFID" name="DSYS01_JFID" value="">
									<input type="hidden" id="YHMOLD" name="YHMOLD" value="${DDJ01.YHM}">
									<input type="hidden" id="zt" name="zt" value=""> <input
										type="hidden" id="JFID" name="JFID" value="${DDJ01.JFID}">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" name="YHM"
												class="form-control" value="${DDJ01.YHM}"
												onblur="yzname(this)">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">所属部门 <i
											style="color: red">*</i></label>
										<div class=" col-md-9">
											<select name="BMBM" class="form-control" size="1">
												<option value="">请选择</option>
												<jf:forEach var="dsys05" items="${listdsys05}">
													<jf:if test="${dsys05.BM==DDJ01.BMBM}">
									...
									<div class="form-group">
										...
										<div class=" col-md-9">
											<input type="text" id="text-input" name="MC"
												class="form-control" value="${DDJ01.MC}">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="xzqh" name="XZQHMC"
												...
												placeholder="请选择行政区划" onclick="tree()" onfocus="this.blur()">（点击选择）
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" name="DZ"
												class="form-control" value="${DDJ01.DZ}" placeholder="请输入地址">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="email" id="email-input" name="YX"
												class="form-control" value="${DDJ01.YX}" placeholder="请输入邮箱">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="textarea-input" name="JJ" rows="3"
												class="form-control" placeholder="说点什么。。。">${DDJ01.JJ}</textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="textarea-input" name="BZ" rows="3"
												class="form-control" placeholder="说点什么。。。">${DDJ01.BZ}</textarea>
										</div>
									</div>
									<div class="form-group">
									...
									<jf:forEach var="list_d" items="${list_d}">
										<div id="${list_d.FWNRLB}" class="form-group">
											...
											<div class="col-md-7">
												<input type="text" id="text-input" class="form-control" value="${list_d.FWNRLBMC}">
												<input type="hidden" id="text-input" name="${list_d.FWNRLB}" class="form-control" value="${list_d.FWNRLB}">
											</div>
											<div class="col-md-2">
												<a class="btn btn-danger" href="javascript:void(0);"
													onclick="remevo('${list_d.FWNRLB}')"> <i
											...
											<div class="col-md-9">
												<textarea id="textarea-input" name="sm${list_d.FWNRLB}"
													rows="3" class="form-control" placeholder="（具体服务内容及价格）">${list_d.SM}</textarea>
											</div>
										</div>
									</jf:forEach>
								</div>
							...
							<div class="modal-footer">
								<a class="btn btn-primary btn-setting" href="#"> <i
									class="fa fa-edit "></i> 增加服务
								</a> <a class="btn btn-primary" href="javascript:void(0);"
									onclick="xgmm()"> <i class="fa fa-edit "></i> 修改系统管理员密码
								</a>
								<button type="button" class="btn btn-primary" onclick="sub(1)">
									<i class="fa fa-check-square"></i> 保存
								</button>
								<a class="btn btn-primary" type="button"
									onclick="xkryxx('${DDJ01.JFID}')"> <i class="fa fa-search "></i>
									人员信息
								</a> <a class="btn btn-danger" href="${path}info/sel.do"> <i
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<textarea id="sm" name="JFREMARK" rows="3"
														class="form-control" placeholder="（具体服务内容及价格）"></textarea>
												</div>
											</div>
											<br>
										</div>
...
<script type="text/javascript">
	...
	function xz() {
		...
		var str = "<div id="
				...
				+ $("#select option:selected").val()
				+ "' rows='9' class='form-control' placeholder='（具体服务内容及价格）'>"
	...
	function yzname(obj) {
		var value = obj.value;
		var JFID = $("#JFID").val();
		var YHMOLD = $("#YHMOLD").val();
		$.ajax({
			type : "post",
			url : "/Myssm_ZBZ/preven/yzname_nouser.do",
			data : {
				JFUSERID : value,
				JFID : JFID,
				YHMOLD : YHMOLD,
			...
			success : function(data) {
				if (data.data == 1) {
					alert("用户名重复请从新输入");
					obj.value = "";
					$("#myfrom").data("bootstrapValidator").updateStatus("YHM",
							"NOT_VALIDATED", null);
					$.obj.focus();
				} else {
					$("#DSYS01_JFID").val(data.data);
				}
			}
		});
	}
