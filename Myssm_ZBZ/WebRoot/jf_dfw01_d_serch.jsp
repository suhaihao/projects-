								...
								<form action="${path}dkzz/sel.do" class="form-inline text-right"
									...
									<div class="form-group">
										<input type="text" id="DDJ02_D_DH" name="DDJ02_D_DH"
											...
											onchange="XG(this)" style="width: 150px;"> <input
											type="hidden" id="DDJ02_D_JFID" name="DDJ02_D_JFID"
											class="form-control" value="${DDJ02_D_JFID}">
									</div>
									<div class="form-group">
...
<script type="text/javascript">
	...
	function xzdk() {
		window.open("/Myssm_ZBZ/dkzz/seldk.do", '_blank',
				"dialogHeight:700px;dialogWidth:1000px");
	}
	function dkxz() {
