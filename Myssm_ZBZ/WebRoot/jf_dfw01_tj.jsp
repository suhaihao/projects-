						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form id="tjfrom" action="${path}fwtj/sel.do" method="post"
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" id="DDJ02_MC" name="DDJ02_MC"
												...
												placeholder="请选择客户"> <input type="hidden"
									...
									<div class="form-group">
										<label class="col-md-2 control-label">统计方式</label> <label
											class="col-md-4">可选统计方式(双击选择)</label> <label class="col-md-1"></label>
										<label class="col-md-4">已选统计方式(双击取消)</label>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<select id="multiple-select1" name="multiple-select1"
												...
												<option id="zfzz" value="A.DDJ01_JFID,A.DDJ01_MC">专防组织</option>
											</select>
										</div>
