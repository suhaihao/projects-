						...
						<div class="panel panel-default">
							...
							<form id="myfrom" action="${path}/jsts/update.do" method="post"
								...
								<div class="panel-body">
									<input name="JFID" type="hidden" value="${dFW22.JFID}">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" name="BT" class="form-control"
												placeholder="请输入标题" value="${dFW22.BT}">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="textarea-input" name="NR" rows="9"
												class="form-control" placeholder="说点什么。。。">${dFW22.NR}</textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<label class="radio-inline"> <jf:if
													...
													<input type="radio" id="inline-radio1" name="SF_ALL"
														checked="checked" value="1" onclick="xz(1)"> 全部
											</jf:if> <jf:if test="${dFW22.SF_ALL!=1}">
													<input type="radio" id="inline-radio1" name="SF_ALL"
												...
												选择
											</jf:if> <jf:if test="${dFW22.SF_ALL!=0}">
													<input type="radio" id="inline-radio2" name="SF_ALL"
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<jf:if test="${fn:contains(fw22_fj.WJM,'jpg')==true}">
													<a href="${path}${fw22_fj.FJ}">${fw22_fj.WJM}</a>
													<a class="btn btn-sm btn-danger" href="javascript:void(0);"
														onclick="sctjfj(this,'${path}jsts/delfj.do?JFID=${fw22_fj.JFID}&DFW22_JFID=${dFW22.JFID}')">
...
<script type="text/javascript">
	...
	function ryxxckwj(retrunvalckwj) {
