				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><i class="fa fa fa-paste"></i>工单明细</li>
						</ol>
					</div>
				</div>
				<!-- main -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>工单查看</strong>
								</h2>
							...
							<div id="body" class="panel-body">
								...
								<form id="myfrom" action="${path}/ordergd/upinfo.do"
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input id="datetimepicker" type="text" id="text-input"
												name="JHSJ" class="form-control" placeholder="请输入计划防治时间（yyyy-mm-d）"
									...
									<div class="form-group">
										<label class="col-md-3 control-label">人工成本</label>
										<div class="col-md-9">
											<input type="text" class="form-control" readonly="readonly"
												value="${dFW01.RGCB}">
										</div>
									...
									<div class="form-group">
										...
										<label class="col-md-2 control-label"
											style="text-align: center;">操作</label>
									</div>
									<jf:forEach var="listdfw01_d" items="${listdfw01_d}">
										<div class="form-group" style="text-align: center;">
											...
											<div class="col-md-2">
													<jf:forEach var="zw" items="${listzw}">
														<jf:if test="${listdfw01_d.ZW==zw.BM}">
															<input type="text" class="form-control" readonly="readonly" value="${zw.HZMC}">
														</jf:if>
													</jf:forEach>
											</div>
											<div class="col-md-2">
											...
											<div class="col-md-2">
												<a
													href="${path}gdcx/gotodklabel.do?JFID=${listdfw01_d.JFID}&SFJE=${dFW01.SFJE}&DDJ02_JFID=${dFW01.DDJ02_JFID}&FWNRLB=${dFW01.FWNRLB}"
									...
									<div class="modal-footer" style="text-align: center;">
										<a class="btn btn-sm btn-danger" data-dismiss="modal"
											href="javascript:history.go(-1);"> <i class="fa fa-reply"></i>
											返回
										</a>
									</div>
								</form>
