					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>技术咨询修改</strong>
								</h2>
								...
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="textarea-input" name="JD" rows="9"
												class="form-control" placeholder="说点什么。。。">${dFW23.JD}</textarea>
										</div>
									</div>
									<br>
									<div class="modal-footer">
										<button type="submit" class="btn btn-sm btn-success"
											onclick="sub(3)">
											<i class="fa fa-dot-circle-o"></i> 解答
										</button>
