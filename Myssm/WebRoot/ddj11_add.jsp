					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form action="${path}order/selfzcs.do" class="navbar-form"
										...
										<jf:forEach var="ddj11" items="${listddj11}">
											<tr>
												...
												<td><input type="radio" name="radio"
													onclick="nyxz('${ddj11.JFID}','${ddj11.MC}','${ddj11.FL}','${ddj11.DW}','${ddj11.DJ}','${ddj11.BZGG}','${ddj11.DWMC}')">
												</td>
											</tr>
										</jf:forEach>
									</tbody>
								...
								<jf:if test="${empty MC and empty FL}">
									<div style="text-align:center;">
										<ul class="pagination">
											...
											<li><a
												href="${path}order/selfzcs.do?page=1&allSize=${page.allSize}"><<</a></li>
											<li><a
												href="${path}order/selfzcs.do?page=${page.page-1}&allSize=${page.allSize}"><</a></li>
											<li class="active"><a>${page.page}</a></li>
											<li><a
												href="${path}order/selfzcs.do?page=${page.page+1}&allSize=${page.allSize}">></a></li>
											<li><a
												href="${path}order/selfzcs.do?page=${page.totalPage}&allSize=${page.allSize}">>></a></li>
								...
								<jf:if test="${not empty MC or not empty FL}">
									<div style="text-align:center;">
										<ul class="pagination">
											<li><a>共${page.totalPage}页</a></li>
											<li><a
												href="${path}order/selfzcs.do?page=1&allSize=${page.allSize}&MC=${MC}&FL=${FL}"><<</a></li>
											<li><a
												href="${path}order/selfzcs.do?page=${page.page-1}&allSize=${page.allSize}&MC=${MC}&FL=${FL}"><</a></li>
											<li class="active"><a>${page.page}</a></li>
											<li><a
												href="${path}order/selfzcs.do?page=${page.page+1}&allSize=${page.allSize}&MC=${MC}&FL=${FL}">></a></li>
											<li><a
												href="${path}order/selfzcs.do?page=${page.totalPage}&allSize=${page.allSize}&MC=${MC}&FL=${FL}">>></a></li>
										</ul>
									</div>
								</jf:if>
								<!--分页结束 -->
...
<script type="text/javascript">
	function nyxz(JFID, MC, FL, DW, DJ, BZGG, DWMC) {
		var id1 = window.opener.document.getElementById('DDJ11_JFID1').value;
		var id2 = window.opener.document.getElementById('DDJ11_JFID2').value;
		if (id1 == JFID || id2 == JFID) {
			alert("不能选择重复");
		} else {
	...
	function xztz(obj, allsize, ml) {
		...
		if (ys != null && ys != "") {
			obj.href = ml + "order/selfzcs.do?page=" + ys + "&allSize="
					+ allsize;
		}
	}
</script>
