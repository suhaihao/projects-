...
<body>
	<%
		...
		EHCache eHCaches = new EHCache("ehcacheMenu");
				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-users"></i>员工管理</li>
						</ol>
					</div>
				</div>
				<!-- main -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>员工管理</strong>
								</h2>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form id="myfrom" action="${path}/preven/add.do" method="post"
						...
						<input type="hidden" name="DDJ01_JFID"
							value="${sessionScope.user.DDJ01_JFID}"> <input
							type="hidden" name="LRRYMC" value="${sessionScope.user.JFNAME}">
									...
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" id="text-input" name="JFUSERID"
														class="form-control" placeholder="请输入账户（建议使用手机号码）"
