				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-bullhorn"></i>通知</li>
						</ol>
					</div>
				</div>
				<!-- main -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>通知查询</strong>
								</h2>
							...
							<div class="panel-body">
								<form action="${path}tz/sel.do" class="navbar-form"
									...
									<tbody>
										<jf:forEach var="dfw21" items="${listdfw21}">
											<tr>
												...
												<td>${dfw21.BT}</td>
												<td><jf:if test="${dfw21.ZT==0}">未读</jf:if> <jf:if
														test="${dfw21.ZT==1}">已读</jf:if></td>
												<td>${dfw21.LRRY}</td>
												<td><a href="javascript:void(0);" class="btn btn-info "
													onclick="qxtj('${dfw21.JFID}')"> <i
											...
											<form id="qxuser${dfw21.JFID}"
												...
												<input type="hidden" name="ZT" value="${dfw21.ZT}" />
											</form>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="panel panel-default">
										<div class="panel-heading">
											<h2>
												<i class="fa fa-indent red"></i><strong>通知信息</strong>
											</h2>
										</div>
										<div class="panel-body">
