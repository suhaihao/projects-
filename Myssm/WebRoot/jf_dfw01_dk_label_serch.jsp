									...
									<div class="col-md-12">
										<div class="panel panel-default">
											<div class="panel-heading">
												<h2>
													<i class="fa fa-indent red"></i><strong>地块查看</strong>
												</h2>
											</div>
											<div class="panel-body">
														...
														<jf:forEach var="syqx" items="${listsyqx}">
															<jf:if test="${fw01_d.SYQX==syqx.BM}">
																<input type="text" id="SYQX" name="SYQX"
																	class="form-control" placeholder="请输入施药器械"
														...
														<div class="col-md-9">
															<jf:if test="${empty fw01_d.SF_FZ}">
																...
																<label class="radio-inline"> <input type="radio"
																	...
																	onclick="pdxz()" disabled="disabled"> 否
																</label>
															</jf:if>
															...
															<jf:if test="${fw01_d.SF_FZ==0}">
																<label class="radio-inline"> <input type="radio"
																	id="inline-radio1" name="SF_FZ" value="1"
																	onclick="pdxz()" disabled="disabled"> 是
																</label>
																<label class="radio-inline"> <input type="radio"
												...
												<div class="form-group">
													...
													<div class="col-md-9">
														<textarea name="SMZT" rows="3" class="form-control"
															placeholder="说点什么。。。" readonly="readonly">${fw01_d.SMZT}</textarea>
													</div>
												</div>
												<div class="modal-footer">
													<a
														...
														class="fa fa-search "></i> 照片
													</a> <a class="btn btn-sm btn-info"
														...
														data-dismiss="modal" href="javascript:history.go(-1);">
