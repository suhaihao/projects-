...
<body>
	...
	<div class="wrap">
		<div class="wrap_top">
			<ul>
				<li>地主：<span>${MC}</span></li>
				<li>面积：<span>${MJ}(亩)</span></li>
				<li>地块名：<span>${DH}</span></li>
				<li>类型：<span><jf:forEach var="dklx" items="${listdklx}">
		...
		<jf:forEach var="dfw01_d" items="${listdfw01_d}">
			<div class="content">
				<div class="con_top">
					...
					<p class="con_p1">
						<em> No.${dfw01_d.JFID}-${dfw01_d.DFW01_JFID}</em> <strong>服务内容:</strong><span>${dfw01_d.FWNRLB}</span>
					<div class="clear"></div>
					</p>
					<div class="clear"></div>
				</div>
				<div class="con_center">
					<ul>
						...
						<div class="clear"></div>
						<li><strong>防治时间:</strong><span>${dfw01_d.LSRQ}</span></li>
						<li><strong>农作物:</strong><span> <jf:if
									test="${dfw01_d.ZW!=99}">
						...
						<li><strong>负责人：</strong><span>${dfw01_d.FZFZR_MC}</span></li>
						<li><strong>防治人员：</strong><span>${dfw01_d.FZRY_MC}</span></li>
						<li><strong>防治对象：</strong><span>${dfw01_d.FZDX}</span></li>
						<li><strong>施药器械：</strong><span>
						<jf:forEach var="syqx" items="${listsyqx}">
						<jf:if test="${dfw01_d.SYQX==syqx.BM}">${syqx.HZMC}</jf:if>
						</jf:forEach>
						</span></li>
						<li><strong>防治面积：</strong><span>${dfw01_d.FZMJ}(亩)</span></li>
						<li><jf:if test="${dfw01_d.SF_FZ==1}">
								<strong style="color: black;">防治</strong>
							</jf:if> <jf:if test="${dfw01_d.SF_XP==1}">
								<strong style="color: black;">巡棚</strong>
							</jf:if></li>
						<li><strong>说明嘱托：</strong><span>${dfw01_d.SMZT}</span></li>
						<li>防治措施</li>
						<div class="clear"></div>
					</ul>
					<table>
