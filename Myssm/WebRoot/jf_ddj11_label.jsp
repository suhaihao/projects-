					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>防治措施查看</strong>
								</h2>
							...
							<div class="panel-body">
								<!-- 表单 -->
								<form id="myfrom" action="${path}/fzcs/qxup.do" method="post"
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<select id="selectfl" name="FL" class="form-control" size="1" disabled="disabled">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" name="MC"
												class="form-control" placeholder="请输入名称" onblur="yzname('${listddj11.JFID}',this)" value="${listddj11.MC}" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" name="DJ"
												class="form-control" placeholder="请输入价格" value="${listddj11.DJ}" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<select id="selectdw" name="DW" class="form-control" size="1" disabled="disabled">
												<option value="">请选择</option>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" name="BZGG"
												class="form-control" placeholder="请输入包装规格" value="${listddj11.BZGG}" disabled="disabled">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">生产厂家
										</label>
										<div class="col-md-9">
											<input type="text" id="text-input" name="SCCJ"
												class="form-control" placeholder="请输入生产厂家" value="${listddj11.SCCJ}" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="textarea-input" name="BZ" rows="3"
												class="form-control" placeholder="说点什么。。。" disabled="disabled">${listddj11.BZ}</textarea>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" 
												class="form-control" readonly="readonly" value="${listddj11.LRRYMC}" >
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" 
												class="form-control" readonly="readonly" value="<fmt:formatDate value="${listddj11.LRRQ}" pattern="yyyy-MM-dd HH:mm:ss"/>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<input type="text" id="text-input" class="form-control" readonly="readonly" value="作废">
										    </jf:if>
										    <jf:if test="${listddj11.ZT==1}">
											<input type="text" id="text-input" class="form-control" readonly="readonly" value="初始">
										    </jf:if>
										    <jf:if test="${listddj11.ZT==2}">
											<input type="text" id="text-input" class="form-control" readonly="readonly" value="提交">
										    </jf:if>
										</div>
									</div>
									<div class="modal-footer">
										<button type="submit" class="btn btn-sm btn-danger">
											<i class="fa fa-reply"></i> 取消提交
										</button>
										<a class="btn btn-sm btn-danger" data-dismiss="modal"
											href="${path}fzcs/sel.do"> <i
