											...
											<div class="panel-body">
												...
												<div id="cs">
													...
													<div class="form-group">
														...
														<label id="NY1" class="col-md-1 control-label"
															style="text-align: left;"> ${fw01_d.DDJ11_DW1MC}
														</label>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<label id="NY2" class="col-md-1 control-label"
															style="text-align: left;"> ${fw01_d.DDJ11_DW2MC}
														</label>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<label id="NY3" class="col-md-1 control-label"
															style="text-align: left;"> ${fw01_d.DDJ11_DW3MC}
														</label>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<label id="NY4" class="col-md-1 control-label"
															style="text-align: left;"> ${fw01_d.DDJ11_DW4MC}
														</label>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="modal-footer">
													...
													<button type="reset" class="btn btn-sm btn-danger"
														data-dismiss="modal" onclick="history.go(-1)">
