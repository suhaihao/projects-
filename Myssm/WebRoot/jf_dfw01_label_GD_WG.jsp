								...
								<form id="myfrom" action="${path}/ordergd/upinfo.do"
									...
									<div class="form-group">
										...
										<label class="col-md-2 control-label"
											...
											class="col-md-1 control-label" style="text-align: center;">状态</label>
										<label class="col-md-2 control-label"
									...
									<jf:forEach var="listdfw01_d" items="${listdfw01_d}">
										<div class="form-group" style="text-align: center;">
											...
											<div class="col-md-2">
												<a
													href="${path}ordergd/gotodklabelWG.do?JFID=${listdfw01_d.JFID}&SFJE=${dFW01.SFJE}&DDJ02_JFID=${dFW01.DDJ02_JFID}&FWNRLB=${dFW01.FWNRLB}"
