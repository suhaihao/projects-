										...
										<jf:forEach var="lis" items="${listddj02}">
											<tr>
												...
												<td><input type="radio" name="redio"
													onclick="xz('${lis.JFID}','${lis.MC}','${lis.ZPLJ}')">
												</td>
											</tr>
								...
								<jf:if test="${empty MC}">
									<div style="text-align:center;">
										<ul class="pagination">
											...
											<li><a
												href="${path}onlin/selNH.do?page=1&allSize=${page.allSize}"><<</a></li>
											<li><a
												href="${path}onlin/selNH.do?page=${page.page-1}&allSize=${page.allSize}"><</a></li>
											<li class="active"><a>${page.page}</a></li>
											<li><a
												href="${path}onlin/selNH.do?page=${page.page+1}&allSize=${page.allSize}">></a></li>
											<li><a
												href="${path}onlin/selNH.do?page=${page.totalPage}&allSize=${page.allSize}">>></a></li>
								...
								<jf:if test="${not empty MC}">
									<div style="text-align:center;">
										<ul class="pagination">
											<li><a>共${page.totalPage}页</a></li>
											<li><a
												href="${path}onlin/selNH.do?page=1&allSize=${page.allSize}&MC=${MC}"><<</a></li>
											<li><a
												href="${path}onlin/selNH.do?page=${page.page-1}&allSize=${page.allSize}&MC=${MC}"><</a></li>
											<li class="active"><a>${page.page}</a></li>
											<li><a
												href="${path}onlin/selNH.do?page=${page.page+1}&allSize=${page.allSize}&MC=${MC}">></a></li>
											<li><a
												href="${path}onlin/selNH.do?page=${page.totalPage}&allSize=${page.allSize}&MC=${MC}">>></a></li>
										</ul>
									</div>
								</jf:if>
								<!--分页结束 -->
...
<script type="text/javascript">
function xz(jfid,mc,ZPLJ)
{
	window.opener.document.getElementById('Str').value=jfid+","+"农户:"+mc+","+ZPLJ;
	window.close();
}
function xztz(obj, allsize, ml) {
	...
	if(ys!=null&&ys!="")
	{
	obj.href = ml + "/onlin/selNH.do?page=" + ys + "&allSize=" + allsize;
	}
}
</script>
</html>