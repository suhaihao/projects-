				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-ambulance"></i>组织信息</li>
						</ol>
					</div>
				</div>
				<!-- main -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>组织信息</strong>
								</h2>
							...
							<form id="myfrom" action="${path}info/ind.do" method="post">
								<div id="body" class="panel-body">
									...
									<input type="hidden" id="zt" name="zt" value="2">
								    <input
									...
									<div class="form-group">
										...
										<div class=" col-md-9">
											<input type="text" id="text-input" name="BMBM"
												class="form-control" value="${DDJ01.BMBM}"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input id="text-input" type="text" name="LRRQ"
												class="form-control" value="${DDJ01.LRRQ}"
												readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div id="${list_d.FWNRLB}" class="form-group">
											...
											<div class="col-md-7">
												<input type="text" id="text-input" class="form-control"
													value="${list_d.FWNRLBMC}"> <input type="hidden"
							...
							<div class="modal-footer">
								<a class="btn btn-info btn-setting" href="#"> <i
									class="fa fa-edit "></i> 添加服务
								</a>
								<button type="button" class="btn btn-success" onclick="sub(2)">
