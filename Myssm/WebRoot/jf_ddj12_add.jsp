					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>防治措施添加</strong>
								</h2>
							...
							<div class="panel-body">
								...
								<form id="myfrom" action="${path}/fzcs/addfzcs.do" method="post"
									...
									<div class="form-group">
										<label class="col-md-3 control-label">单价 <i
											style="color: red">*</i>
										</label>
										<div class="col-md-9">
											<input type="text" id="text-input" name="DJ"
												class="form-control" placeholder="请输入价格" value="${dDJ12.DJ}">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label">单位 <i
											style="color: red">*</i>
										</label>
										<div class="col-md-9">
									...
									<div class="form-group">
										<label class="col-md-3 control-label">包装规格 <i
											style="color: red">*</i>
										</label>
										<div class="col-md-9">
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" name="SCCJ"
												class="form-control" placeholder="请输入生产厂家" value="${dDJ12.SCCJ}">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea id="textarea-input" name="BZ" rows="3"
												class="form-control" placeholder="说点什么。。。">${dDJ12.BZ}</textarea>
										</div>
									</div>
									<div class="modal-footer">
										...
										<a class="btn btn-sm btn-danger" data-dismiss="modal"
											href="${path}/fzcs/add.do"> <i class="fa fa-ban"></i> 返回
										</a>
									</div>
								</form>
