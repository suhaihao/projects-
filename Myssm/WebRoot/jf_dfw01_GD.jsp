				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-file-text-o"></i>工单处理</li>
						</ol>
					</div>
				</div>
				<!-- main -->
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h2>
									<i class="fa fa-table red"></i><span class="break"></span><strong>工单处理</strong>
								</h2>
							...
							<div class="panel-body">
								<form action="${path}ordergd/sel.do"
									...
									<tbody>
										<jf:forEach var="dfw01" items="${lisdfw01}">
											...
											<form id="qxuser${dfw01.JFID}"
												action="${path}ordergd/gotolabel.do" method="post">
												<input type="hidden" name="id" value="${dfw01.JFID}" />
											</form>
											<form id="upuser${dfw01.JFID}"
												action="${path}ordergd/gotoup.do" method="post">
												<input type="hidden" name="id" value="${dfw01.JFID}" />
											</form>
										</jf:forEach>
									</tbody>
								...
								<jf:if
									...
									<div style="text-align:center;">
										<ul class="pagination">
											...
											<li><a
												href="${path}/ordergd/sel.do?page=1&allSize=${page.allSize}"><<</a></li>
											<li><a
												href="${path}/ordergd/sel.do?page=${page.page-1}&allSize=${page.allSize}"><</a></li>
											<li class="active"><a>${page.page}</a></li>
											<li><a
												href="${path}/ordergd/sel.do?page=${page.page+1}&allSize=${page.allSize}">></a></li>
											<li><a
												href="${path}/ordergd/sel.do?page=${page.totalPage}&allSize=${page.allSize}">>></a></li>
								...
								<jf:if
									...
									<div style="text-align:center;">
										<ul class="pagination">
											<li><a>共${page.totalPage}页</a></li>
											<li><a
												href="${path}/ordergd/sel.do?page=1&allSize=${page.allSize}&StarTime=${StarTime}&EndTime=${EndTime}&DDJ02_MC=${DDJ02_MC}"><<</a></li>
											<li><a
												href="${path}/ordergd/sel.do?page=${page.page-1}&allSize=${page.allSize}&StarTime=${StarTime}&EndTime=${EndTime}&DDJ02_MC=${DDJ02_MC}"><</a></li>
											<li class="active"><a>${page.page}</a></li>
											<li><a
												href="${path}/ordergd/sel.do?page=${page.page+1}&allSize=${page.allSize}&StarTime=${StarTime}&EndTime=${EndTime}&DDJ02_MC=${DDJ02_MC}">></a></li>
											<li><a
												href="${path}/ordergd/sel.do?page=${page.totalPage}&allSize=${page.allSize}&StarTime=${StarTime}&EndTime=${EndTime}&DDJ02_MC=${DDJ02_MC}">>></a></li>
										</ul>
									</div>
								</jf:if>
								<!--分页结束 -->
...
<script type="text/javascript">
	function openwindow(jfid) {
		if (jfid != "") {
			window
					.open("/Myssm/tz/gotolabeldl.do?JFID=" + jfid + "&ZT=0",
							'_blank',
	...
	function openwindowjsts(jfid) {
		if (jfid != "") {
			window
					.open("/Myssm/jsts/gotolabeldl.do?JFID=" + jfid + "&ZT=0",
							'_blank',
							"dialogWidth=800px;dialogHeight=auto;height=auto");
		}
	}
	...
	function xztz(obj, allsize, ml) {
		...
		if (ys != null && ys != "") {
			obj.href = ml + "/ordergd/sel.do?page=" + ys + "&allSize="
					+ allsize;
		}
	}
	function tjgx(id) {
