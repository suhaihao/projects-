									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="xzqh" name="XZQHMC"
												...
												value="${dDJ02.XZQHMC}" readonly="readonly"><input type="hidden"
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" name="YDDH"
												class="form-control" value="${dDJ02.YDDH}"  readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<jf:if test="${dDJ02.YHLB==1}">
												<label class="radio-inline"> <input
													...
													checked="checked" onclick="choce(this)" disabled="disabled"> 个人
												</label>
												<label class="radio-inline"> <input
											...
											<jf:if test="${dDJ02.YHLB==0}">
												...
												<label class="radio-inline"> <input
													type="radio" id="inline-radio2" name="YHLB" value="0"
													checked="checked" onclick="choce(this)" disabled="disabled"> 单位
												</label>
											</jf:if>
										</div>
									</div>
										...
										<div id="bl">
											<div class="form-group">
												...
												<jf:if test="${dDJ02.XB==0}">
													<div class="col-md-9">
														<label class="radio-inline"> <input
															type="radio" id="inline-radio1" name="XB" value="1" disabled="disabled">
															男
														</label> <label class="radio-inline">
															<input type="radio" id="inline-radio2" name="XB"
															value="0" checked="checked" disabled="disabled"> 女
														</label>
													</div>
												</jf:if>
											</div>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input id="datetimepicker" type="text" name="SR"
														...
														value="<fmt:formatDate value="${dDJ02.SR}" pattern="yyyy-MM-dd"/>" readonly="readonly">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-9">
														<jf:forEach var="xl" items="${listxl}">
															<jf:if test="${dDJ02.XL==xl.BM}">
																<input type="text" class="form-control" value="${xl.HZMC}" readonly="readonly">
															</jf:if>
														</jf:forEach>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" id="text-input" name="JTRK"
														class="form-control" 
														value="${dDJ02.JTRK}" readonly="readonly">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" id="text-input" name="RJSR"
														class="form-control" 
														value="${dDJ02.RJSR}" readonly="readonly">
												</div>
											</div>
										</div>
										<div id="bbl" style="display: none;">
											<div class="form-group">
												...
												<jf:if test="${dDJ02.XB==0}">
													<div class="col-md-9">
														<label class="radio-inline"> <input
															type="radio" id="inline-radio1" name="XBN" value="1" disabled="disabled">
															男
														</label> <label class="radio-inline">
															<input type="radio" id="inline-radio2" name="XBN"
															value="0" checked="checked" disabled="disabled"> 女
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" name="SCMJ"
												class="form-control" 
												value="${dDJ02.SCMJ}" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" id="text-input" name="FWNR"
												class="form-control" 
												value="${dDJ02_DDJ01.FWNR}" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
