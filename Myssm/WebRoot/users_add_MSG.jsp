					...
					<div class="panel-body">
						<form action="${path}onlin/selZFZZandRY.do" class="navbar-form"
							...
							<div style="text-align: right;">
								<label>专访组织： </label> <select id="select" name="DDJ01_JFID"
						...
						<div style="text-align:center;">
							<ul class="pagination">
								...
								<li><a href="javascript:void(0);"
									onclick="xztz(this,'${page.allSize}','${path}','&XXDBLB=${XXDBLB}&JFID=${JFID}&DDJ01_JFID=${DDJ01_JFID}&JFNAME=${JFNAME}')">点击选择跳转</a></li>
							</ul>
						</div>
						<!--分页结束 -->
					</div>
