...
<jsp:include page="/header.jsp" flush="true">
	<jsp:param name="title" value="增加通知公告" />
</jsp:include>
...
<tr>
  ...
  <td  width="400px"align="left">
    <input name="gjc" size="30"  chname="部门名称" nullable="no"/>
  </td>
    </tr>
    <tr>
...
<script language="javascript">
	function f_refreshOpener() {
		window.location = "/insect/xxfb_tzggAction.do?ACT_TYPE=DETAIL&zt=0&id=${id}";
		parent.opener.window.location = "/insect/xxfb/tzgg_query.jsp";
	}

function f_save(zt){
       document.f1.action = "/insect/xxfb_tzggAction.do?ACT_TYPE=INSERT&zt="+zt;
