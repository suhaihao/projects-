...
<tr>
  ...
  <td  width="400px"align="left">
        ...
        <mt:ufreeselect chname="部门属性" name="dcbgf:lb:str:s" nullable="no" optvalue="01:02" opttext="北京:全国" other="style='width:30%'">
          </mt:ufreeselect>
      </span>
  </td>
</tr>
<tr>
  ...
  <td  width="400px"align="left">
        <span style="width:180px;border:1px solid #797a98">
        <mt:ufreeselect chname="部门属性" name="dcbgf:lx:str:s" nullable="no" optvalue="01:02:03:04" opttext="国标:行标:地标:测报办法" other="style='width:30%'">
          </mt:ufreeselect>
      </span>
  </td>
</tr>
    ...
    <tr>
      <td align="right"><div class="cell-wrap">附件:</div></td>
      <td width="400px"align="left">       
								<a href="javascript:void(0);" onclick="up('${ID}','dcbgf_fj');return false;" class="choose" title="选择附件">选择</a>
								<style type="text/css">
								.J_xxfj td{
									border:0px;
								}
								...
								<mt:mastersheet detailindex="1">
									<tr><td>
										<a onclick="window.open('/insect/file_down.jsp?path=<mt:ulabel name="d:lj:str:s"/>&mc=encodeURI(<mt:ulabel name="d:wjm:str:s"/>)')" href="javascript:void(0)"><mt:ulabel name="d:wjm:str:s"/></a>
										<a class="del" title="删除" onclick="return confirm('确实要删除吗?');" href="/insect/xxfb_cbgfQueryAction.do?ACT_TYPE=DEL&idd=${ID}&path=<mt:ulabel name="d:lj:str:s"/>&id=<mt:ulabel name="d:jfid:str:s"/>">X</a>
									</td></tr>
								</mt:mastersheet>
								</table>
      </td>
