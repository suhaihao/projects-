        ...
        <div class="layout-main">
            <div class="layout-wrap">
            	<div class="mod">
					...
					<div class="mod-bd">
		                <form name="f1" method="post" action="/insect/bbhz.do?ACT_TYPE=QUERY" target="result">
							<table class="w">
								<tr>
									...
									<td style="width:165px">
										<mt:freeselect id="jflb" name="jflb" datamember="dsys11" select="jfcode,jfremark" where="jfsort='BBLB' and length(jfcode)=4 and jfcode not in('0304','0303','0302','0301')" sort="jfid"></mt:freeselect>
									</td>
				...
				<iframe id="result" name="result" style="width:100%;border:0px;" scrolling="no" onload="iFrameHeight()" src="/insect/bbhz.do?ACT_TYPE=QUERY"></iframe>
        	</div>
    	</div>
		<!-- menu -->
