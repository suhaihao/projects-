...
<div class="mod">
	...
	<script type="text/javascript">
		...
		function f_exp(){
			window.location = "/insect/bbhz/bbhz_update.jsp?p=exp&dbbzb_tj_jfid=<%=dbbzb_tj_jfid %>&wh=<%=_where %>&dc=<%=dc%>&col=<%=colNumber+tjfs_tag.length %>&sl=" + encodeURIComponent(encodeURIComponent("<%=_select_%>"));
		}
	</script>
