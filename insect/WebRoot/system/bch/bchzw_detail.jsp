...
<tr>
  ...
  <td  width="400px"align="left">
        <span style="width:180px;border:1px solid #797a98">
           <mt:uselect name="dqbfb:JFPLANTCODE:str:s" datamember="dzw" chname="部门名称" nullable="no" select="JFPLANTCODE,JFPLANTNAME" where=" JFSTATE='1' " >
           </mt:uselect>
      </span>
  </td>
</tr>
      ...
      <td >       
								...
								<mt:mastersheet detailindex="1">
									<tr><td>
										...
										<a class="del" title="删除" onclick="return confirm('确实要删除吗?');" href="/insect/bchAction.do?ACT_TYPE=DEL_ZW&idd=${ID}&path=<mt:ulabel name="d:lj:str:s"/>&id=<mt:ulabel name="d:jfid:str:s"/>">X</a>
									</td></tr>
								</mt:mastersheet>
								</table>
      </td>
