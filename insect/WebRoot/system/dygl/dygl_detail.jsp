...
<jsp:include page="/header.jsp" flush="true">
	<jsp:param name="title" value="地域修改" />
</jsp:include>
...
<tr>
  ...
  <td  width="400px"align="left">
        <mt:vlabel name="d_hy_zx:JFREGCODE:str:s"/>
        <mt:vinput name="d_hy_zx:JFREGCODE:str:s" type="hidden"/>
  </td>
</tr>
<tr>
  <td align="right" ><div class="cell-wrap">地域名称：</div></td>
  <td  width="400px"align="left">
    <mt:vinput name="dfirm_zhg:JFREGNAME:str:s" other="size='50' maxlength='100'"/>
  </td>
</tr>
    <tr>
      ...
      <td >
        <span style="width:180px;border:1px solid #797a98">
          <mt:vfreeselect chname="地域属性" name="dfirm_zhg:JFREGPROP:str:s" nullable="no" optvalue="0:1" opttext="近郊区:远郊区">
          </mt:vfreeselect>
      </span>
      </td>
    </tr>
...
function f_query(){
       document.f1.action = "/insect/dyglAction.do?ACT_TYPE=UPDATE";
...
function f_refreshOpener()
{
  ...
  window.document.location.replace("/insect/dyglAction.do?ACT_TYPE=DETAIL&jfid="+jfid);
}
