	...
	<form id="f1" name="f1" action="/insect/tjbcsj.do?ACT_TYPE=Q<%=zbid%>"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				...
				<tr>
				<td colspan=3 rowspan=1><input style="width: 100%;" name="MD_ZZMJ" type="text"
				...
				<td colspan=2 rowspan=1><input style="width: 100%;" name="ZTMQYCNBJ" type="text"
						value="<%=ZTMQYCNBJ%>"/></td>
				<td><input style="width: 100%;" name="ZS" type="text"
						value="<%=ZS%>"/></td>
				<td><input style="width: 100%;" name="ZZPZKCX" type="text"
						value="<%=ZZPZKCX%>"/></td>
				</tr>
				<tr>
			...
			<tbody id="zg_body">
				...
				<tr>
					...
					<td><select name="YC_CD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="XJC_CD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="DXHC_CD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
