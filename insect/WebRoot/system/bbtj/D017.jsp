...
<body>
	...
	<form id="f1" name="f1" action="/insect/tjbcsj_t.do?ACT_TYPE=Q<%=zbid%>"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tr>
			<td><input style="width: 100%;" name=YDZMJ type="text"
						value="<%=YDZMJ%>" alertname="越冬总面积必须为数字" datatype="number" /></td>
			<td><input style="width: 100%;" name=YDHJMD type="text"
						value="<%=YDHJMD%>" alertname="越冬活茧密度必须为数字" datatype="number" /></td>
			<td colspan="2" style="text-align: center;">\</td>
			<td><input style="width: 100%;" name=YDZCL type="text"
						value="<%=YDZCL%>" alertname="越冬总虫量必须为数字" datatype="number" /></td>
