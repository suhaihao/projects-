		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>三代玉米螟为害调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D904_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D904_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D904_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D904_BODY:DCRQ:D"
							style="width:85;height: ;font-size:12"
							value=" <mt:vlabel name="D904_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D904_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D904_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02" other="chname='寄主作物' nullable='no'"
								name="D904_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='BBYMMZW' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y03" other="chname='生育期' nullable='no'"
								name="D904_BODY:Y03:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_YMSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D904_BODY:Y04:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y04:str:N" />" chname="调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D904_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y05:str:N" />"
							chname="有虫株数(株)植株受害情况" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D904_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y06:str:N" />"
							chname="虫株率（%）植株受害情况" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y05/Y04)*100";gsjg[gsjg.length]="Y06";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D904_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y07:str:N" />"
							chname="被害株数(株)植株受害情况" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D904_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y08:str:N" />"
							chname="被害株率（%）植株受害情况" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y05/Y07)*100";gsjg[gsjg.length]="Y08";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D904_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y09:str:N" />"
							chname="♀穗(株)植株受害情况" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D904_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y10:str:N" />"
							chname="♂穗(株)植株受害情况" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D904_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y11:str:N" />"
							chname="蛀茎(株)植株受害情况" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D904_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y12:str:N" />"
							chname="折秆(株)植株受害情况" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D904_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y13:str:N" />"
							chname="花叶(株)植株受害情况" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D904_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y14:str:N" />" chname="活玉米螟（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D904_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y15:str:N" />" chname="死玉米螟（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D904_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y16:str:N" />" chname="活条螟（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D904_BODY:Y17:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y17:str:N" />" chname="死条螟（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D904_BODY:Y18:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y18:str:N" />" chname="活桃蛀螟（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y19" name="D904_BODY:Y19:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y19:str:N" />" chname="死桃蛀螟（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y20" name="D904_BODY:Y20:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y20:str:N" />"
							chname="活百株虫量（头/百株）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="((Y14+Y16+Y18)/Y04)*100";gsjg[gsjg.length]="Y20";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y21" name="D904_BODY:Y21:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y21:str:N" />"
							chname="死百株虫量（头/百株）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="((Y15+Y17+Y19)/Y04)*100";gsjg[gsjg.length]="Y21";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y22" name="D904_BODY:Y22:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D904_BODY:Y22:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D904_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D904_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: ;font-size:12"
					value="<%=username%>" /></td>
			</tr>
