		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width:400;height: "><b>玉米螟冬后存活调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D910_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D910_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: "
					value="<%=zt%>" /></td>
			</tr>
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>调查秆数(株)</b></td>
					<td colspan=5 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>玉米螟</b></td>
					<td colspan=5 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>条螟</b></td>
					<td colspan=5 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>桃蛀螟</b></td>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>百秆活虫(头/百株)</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>备注</b></td>
				</tr>
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>活虫(头)</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>死虫(头)</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计(头)</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>死亡率（％）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>存活率（％）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>活虫(头)</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>死虫(头)</b></td>
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D910_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D910_BODY:DCRQ:D"
							style="width:85;height: ;font-size:12"
							value=" <mt:vlabel name="D910_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D910_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D910_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D910_BODY:Y02:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y02:str:N" />" chname="调查秆数(株)"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D910_BODY:Y03:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y03:str:N" />"
							chname="活虫(头)玉米螟" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D910_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y04:str:N" />"
							chname="死虫(头)玉米螟" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D910_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y05:str:N" />"
							chname="合计(头)玉米螟" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y03+Y04";gsjg[gsjg.length]="Y05";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D910_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y06:str:N" />"
							chname="死亡率（％）玉米螟" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y04/Y05*100";gsjg[gsjg.length]="Y06";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D910_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y07:str:N" />"
							chname="存活率（％）玉米螟" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y03/Y05*100";gsjg[gsjg.length]="Y07";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D910_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y08:str:N" />" chname="活虫(头)条螟"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D910_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y09:str:N" />" chname="死虫(头)条螟"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D910_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y10:str:N" />" chname="合计(头)条螟"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y08+Y09";gsjg[gsjg.length]="Y10";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D910_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y11:str:N" />"
							chname="死亡率（％）条螟" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y09/Y10*100";gsjg[gsjg.length]="Y11";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D910_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y12:str:N" />"
							chname="存活率（％）条螟" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y08/Y10*100";gsjg[gsjg.length]="Y12";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D910_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y13:str:N" />"
							chname="活虫(头)桃蛀螟" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D910_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y14:str:N" />"
							chname="死虫(头)桃蛀螟" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D910_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y15:str:N" />"
							chname="合计(头)桃蛀螟" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y13+Y14";gsjg[gsjg.length]="Y15";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D910_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y16:str:N" />"
							chname="死亡率（％）桃蛀螟" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y14/Y15*100";gsjg[gsjg.length]="Y16";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D910_BODY:Y17:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y17:str:N" />"
							chname="存活率（％）桃蛀螟" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y13/Y15*100";gsjg[gsjg.length]="Y17";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D910_BODY:Y18:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y18:str:N" />"
							chname="玉米螟百秆活虫(头/百株)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y03/Y02*100";gsjg[gsjg.length]="Y18";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y19" name="D910_BODY:Y19:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y19:str:N" />"
							chname="条螟百秆活虫(头/百株)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y08/Y02*100";gsjg[gsjg.length]="Y19";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y20" name="D910_BODY:Y20:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y20:str:N" />"
							chname="桃蛀螟百秆活虫(头/百株)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y13/Y02*100";gsjg[gsjg.length]="Y20";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y21" name="D910_BODY:Y21:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y21:str:N" />"
							chname="合计百秆活虫(头/百株)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y18+Y19+Y20";gsjg[gsjg.length]="Y21";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y22" name="D910_BODY:Y22:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D910_BODY:Y22:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D910_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D910_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
