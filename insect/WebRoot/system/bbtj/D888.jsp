		...
		%><table
			...
			<tr>
				<td colspan=6 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>北京市农区鼠害普查记录表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D888_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D888_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:200;height: "
					value="<%=zt%>" /></td>
			</tr>
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>栖息地</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>样地号</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>置铗数</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>有效铗数</b></td>
					<td colspan=9 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>害鼠种类（只）</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>小计</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>捕获率（%）</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>天气情况</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>备注</b></td>
				</tr>
				<tr>
					<td colspan=2 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>大仓鼠</b></td>
					<td colspan=2 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>黑线姬鼠</b></td>
					<td colspan=2 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>小家鼠</b></td>
					<td colspan=2 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>褐家鼠</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>其它鼠类</b></td>
				</tr>
				<tr>
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D888_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D888_BODY:DCRQ:D"
							style="width:70;height: ;font-size:12"
							value=" <mt:vlabel name="D888_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D888_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D888_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02" other="chname='栖息地' nullable='no'"
								name="D888_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_SLQXD' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D888_BODY:Y03:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y03:str:S" />" chname="样地号"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D888_BODY:Y04:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y04:str:N" />" chname="置铗数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D888_BODY:Y05:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y05:str:N" />" chname="有效铗数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D888_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y06:str:N" />" chname="大仓鼠♀"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D888_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y07:str:N" />" chname="大仓鼠♂"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D888_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y08:str:N" />" chname="黑线姬鼠♀"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D888_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y09:str:N" />" chname="黑线姬鼠♂"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D888_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y10:str:N" />" chname="小家鼠♀"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D888_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y11:str:N" />" chname="小家鼠♂"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D888_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y12:str:N" />" chname="褐家鼠♀"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D888_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y13:str:N" />" chname="褐家鼠♂"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D888_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y14:str:N" />" chname="其它鼠类"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D888_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y15:str:N" />" chname="小计"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y06+Y07+Y08+Y09+Y10+Y11+Y12+Y13+Y14";gsjg[gsjg.length]="Y15";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D888_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y16:str:N" />" chname="捕获率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y15/Y05*100";gsjg[gsjg.length]="Y16";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D888_BODY:Y17:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y17:str:S" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D888_BODY:Y18:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D888_BODY:Y18:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D888_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D888_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:90;height: ;font-size:12"
					value="<%=username%>" /></td>
			</tr>
