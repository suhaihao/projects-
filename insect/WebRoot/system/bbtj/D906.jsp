		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width:400;height: "><b>玉米螟越冬基数调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D906_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: "
					value="<%=bmmc%>" /></td>
				<td colspan=1 rowspan=1 style="font-size:12;width:50;height: "><b>
				</b></td>
				<td colspan=1 rowspan=1 style="font-size:12;width: ;height: "><b>状态</b></td>
				<td colspan=1 rowspan=1><input type="hidden"
					name="D906_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: "
					value="<%=zt%>" /></td>
			</tr>
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>调查秆数</b></td>
					<td colspan=6 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>玉米螟虫数（头）</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>条螟虫数（头）</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>桃蛀螟（头）</b></td>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>百秆活虫数(头)</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>死亡率（%）</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>备注</b></td>
				</tr>
				<tr>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>活</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>死</b></td>
					<td colspan=1 rowspan=2
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>玉</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>条</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>桃</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>玉</b></td>
				...
				<tr>
					...
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>4龄</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>5龄</b></td>
					<td colspan=1 rowspan=1
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D906_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D906_BODY:DCRQ:D"
							style="width:85;height: ;font-size:12"
							value=" <mt:vlabel name="D906_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D906_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D906_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D906_BODY:Y02:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y02:str:N" />" chname="调查秆数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D906_BODY:Y03:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y03:str:N" />" chname="3龄以下活"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D906_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y04:str:N" />"
							chname="4龄活玉米螟虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D906_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y05:str:N" />"
							chname="5龄活玉米螟虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D906_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y06:str:N" />"
							chname="蛹活玉米螟虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D906_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y07:str:N" />" chname="死螟虫数（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D906_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y08:str:N" />"
							chname="合计螟虫数（头）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" Y03+Y04+Y05+Y06+Y07";gsjg[gsjg.length]="Y08";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D906_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y09:str:N" />"
							chname="活条螟虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D906_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y10:str:N" />"
							chname="死条螟虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D906_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y11:str:N" />"
							chname="合计条螟虫数（头）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" Y09+Y10";gsjg[gsjg.length]="Y11";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D906_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y12:str:N" />" chname="活桃蛀螟（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D906_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y13:str:N" />" chname="死桃蛀螟（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D906_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y14:str:N" />"
							chname="合计桃蛀螟（头）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" Y12+Y13";gsjg[gsjg.length]="Y14";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D906_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y15:str:N" />"
							chname="玉百秆活虫数(头)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" (Y08-Y07)/Y02*100";gsjg[gsjg.length]="Y15";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D906_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y16:str:N" />"
							chname="条百秆活虫数(头)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" (Y09/Y02)*100";gsjg[gsjg.length]="Y16";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D906_BODY:Y17:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y17:str:N" />"
							chname="桃百秆活虫数(头)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="  (Y12/Y02)*100";gsjg[gsjg.length]="Y17";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D906_BODY:Y18:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y18:str:N" />"
							chname="合计百秆活虫数(头)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" Y15+Y16+Y17";gsjg[gsjg.length]="Y18";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y19" name="D906_BODY:Y19:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y19:str:N" />" chname="玉死亡率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" (Y07/Y08)*100";gsjg[gsjg.length]="Y19";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y20" name="D906_BODY:Y20:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y20:str:N" />" chname="条死亡率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" (Y10/Y11)*100";gsjg[gsjg.length]="Y20";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y21" name="D906_BODY:Y21:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y21:str:N" />" chname="桃死亡率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" (Y13/Y14)*100";gsjg[gsjg.length]="Y21";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y22" name="D906_BODY:Y22:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D906_BODY:Y22:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D906_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D906_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
