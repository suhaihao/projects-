		...
		%><table
			...
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width:700;height: "><b>小麦叶锈病普查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				<td colspan=1 rowspan=1 style="font-size:12;width:90;height: "><b>调查单位:</b></td>
				<td colspan=1 rowspan=1><input type="hidden"
					name="D860_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1 style="font-size:12;width:50;height: "><b>状态:</b></td>
				<td colspan=1 rowspan=1><input type="hidden"
					name="D860_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>小麦生育期</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>调查株数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>发病株数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>病株率（%）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>调查总叶数（片）</b></td>
					<td colspan=8 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>发病叶数（片）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>病叶率%</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>平均严重度%</b></td>
					<td colspan=1 rowspan=2
				...
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>1%</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>5%</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>10%</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>20%</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>40%</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>60%</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>80%</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>100%</b></td>
				</tr>
			</tbody>
			<tbody id="zg_body">
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D860_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D860_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D860_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D860_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D860_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D860_BODY:Y02:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y02:str:S" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y03" other="chname='小麦生育期' nullable='no'"
								name="D860_BODY:Y03:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_XMSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D860_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y04:str:N" />" chname="调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D860_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y05:str:N" />" chname="发病株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D860_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y06:str:N" />" chname="病株率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y05/Y04*100";gsjg[gsjg.length]="Y06";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D860_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y07:str:N" />"
							chname="调查总叶数（片）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D860_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y08:str:N" />"
							chname="发病叶数（片）1%" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D860_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y09:str:N" />"
							chname="发病叶数（片）5%" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D860_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y10:str:N" />"
							chname="发病叶数（片）10%" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D860_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y11:str:N" />"
							chname="发病叶数（片）20%" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D860_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y12:str:N" />"
							chname="发病叶数（片）40%" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D860_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y13:str:N" />"
							chname="发病叶数（片）60%" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D860_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y14:str:N" />"
							chname="发病叶数（片）80%" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D860_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y15:str:N" />"
							chname="发病叶数（片）100%" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D860_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y16:str:N" />" chname="病叶率%"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y08+Y09+Y10+Y11+Y12+Y13+Y14+Y15)/Y07*100";gsjg[gsjg.length]="Y16";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D860_BODY:Y17:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y17:str:N" />" chname="平均严重度%"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y08+Y09*2+Y10*3+Y11*4+Y12*5+Y13*6+Y14*7+Y15*8)/Y16";gsjg[gsjg.length]="Y17";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D860_BODY:Y18:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y18:str:N" />" chname="病情指数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y16*Y17*100";gsjg[gsjg.length]="Y18";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y19" name="D860_BODY:Y19:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D860_BODY:Y19:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D860_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D860_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
