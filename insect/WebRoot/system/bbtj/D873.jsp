		...
		%><table
			...
			<tr>
				<td colspan=8 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>二代粘虫残虫量调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D873_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D873_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width: ;height: "
					value="<%=zt%>" /></td>
			</tr>
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D873_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D873_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D873_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D873_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D873_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02" other="chname='作物种类' nullable='no'"
								name="D873_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='BBNCTJ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D873_BODY:Y03:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D873_BODY:Y03:str:N" />" chname="取样数(m2)"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D873_BODY:Y04:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D873_BODY:Y04:str:N" />" chname="幼虫数量(头)"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D873_BODY:Y05:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D873_BODY:Y05:str:N" />"
							chname="幼虫密度(头/m2)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y04/Y03";gsjg[gsjg.length]="Y05";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D873_BODY:Y06:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D873_BODY:Y06:str:N" />" chname="蛹量（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D873_BODY:Y07:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D873_BODY:Y07:str:N" />"
							chname="蛹密度（头/m2）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y06/Y03";gsjg[gsjg.length]="Y07";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D873_BODY:Y08:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D873_BODY:Y08:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D873_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D873_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
