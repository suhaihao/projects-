		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width:400;height: "><b>花生田棉铃虫为害普查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D917_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D917_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: "
					value="<%=zt%>" /></td>
			</tr>
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>1m2调查株数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>1m2有虫株数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>1m2有虫株率(%)</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>卵量（百株或1m2）</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>虫口密度（头/
							m2）</b></td>
					<td colspan=1 rowspan=2
				...
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>三龄以下</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>三龄以上</b></td>
					<td colspan=1 rowspan=1
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D917_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D917_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D917_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D917_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D917_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02" other="chname='有无地膜覆盖' nullable='no'"
								name="D917_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='BBYWBM' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D917_BODY:Y03:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D917_BODY:Y03:str:N" />" chname="1m2调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D917_BODY:Y04:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D917_BODY:Y04:str:N" />" chname="1m2有虫株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D917_BODY:Y05:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D917_BODY:Y05:str:N" />"
							chname="1m2有虫株率(%)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y04/Y03*100";gsjg[gsjg.length]="Y05";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D917_BODY:Y06:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D917_BODY:Y06:str:N" />"
							chname="卵量（百株或1m2）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D917_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D917_BODY:Y07:str:N" />"
							chname="三龄以下虫口密度（头/ m2）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D917_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D917_BODY:Y08:str:N" />"
							chname="三龄以上虫口密度（头/ m2）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D917_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D917_BODY:Y09:str:N" />"
							chname="合计虫口密度（头/ m2）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y07+Y08";gsjg[gsjg.length]="Y09";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D917_BODY:Y10:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D917_BODY:Y10:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D917_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D917_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: ;font-size:12"
					value="<%=username%>" /></td>
			</tr>
