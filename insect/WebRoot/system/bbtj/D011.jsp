...
<body>
	<%
		...
		if (!bbzt.equals("0")) {
			...
			try {
				String sql = "select * from D011 where jfid=" + jfid;
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>二代玉米螟发生情况模式报表(<%=rwsj%>)
				</b><br> <br></td>
			</tr>
			<tr>
			...
			<tbody id="zg_body">
				 ...
				 <tr>
					...
					<td><input style="width: 100%;" name="HYSQBLNPJZZWTS" type="text"
						value="<%=HYSQBLNPJZZWTS%>" alertname="化蛹盛期比历年平均值早晚天数必须为数字" datatype="number"/></td>
				</tr>
				 <tr>
				...
				<tr>
					...
					<td colspan=1 rowspan=2><input style="width: 100%;" name="BZYXLKSBSNZJBL" type="text"
						value="<%=BZYXLKSBSNZJBL%>" alertname="百株有效卵块数比上年值增减比率必须为数字" datatype="number" /></td>
