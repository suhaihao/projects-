		...
		%><table
			...
			<tr>
				<td colspan=8 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>地下害虫危害情况普查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D865_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D865_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width: ;height: "
					value="<%=zt%>" /></td>
			</tr>
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=5 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>被害株数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>为害率（%）</b></td>
					<td colspan=1 rowspan=2
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D865_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D865_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D865_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D865_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D865_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D865_BODY:Y02:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D865_BODY:Y02:str:S" />" chname="前茬"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D865_BODY:Y03:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D865_BODY:Y03:str:S" />" chname="作物"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D865_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D865_BODY:Y04:str:N" />" chname="调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D865_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D865_BODY:Y05:str:N" />" chname="蝼蛄被害株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D865_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D865_BODY:Y06:str:N" />" chname="金针虫被害株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D865_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D865_BODY:Y07:str:N" />" chname="蛴螬被害株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D865_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D865_BODY:Y08:str:N" />" chname="其他被害株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D865_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D865_BODY:Y09:str:N" />" chname="被害株数合计"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y05+Y06+Y07+Y08";gsjg[gsjg.length]="Y09";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D865_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D865_BODY:Y10:str:N" />" chname="为害率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y09/Y04";gsjg[gsjg.length]="Y10";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D865_BODY:Y11:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D865_BODY:Y11:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D865_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D865_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: ;font-size:12"
					value="<%=username%>" /></td>
			</tr>
