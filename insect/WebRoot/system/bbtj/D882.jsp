		...
		%><table
			...
			<tr>
				<td colspan=6 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>玉米苗期害虫调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D882_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D882_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>调查株数（株）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>生育期</b></td>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>蓟马</b></td>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>蚜虫</b></td>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>棉铃虫</b></td>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>草地螟</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>备注</b></td>
				</tr>
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>虫株数（株）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>总虫量(头)</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>被害株率（%）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>百株虫量(头)</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>虫株数（株）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>总虫量(头)</b></td>
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D882_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D882_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D882_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D882_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D882_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D882_BODY:Y02:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y02:str:N" />" chname="调查株数（株）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y03" other="chname='生育期' nullable='no'"
								name="D882_BODY:Y03:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_YMSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D882_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y08:str:N" />"
							chname="蓟马虫株数（株）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D882_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y09:str:N" />"
							chname="蓟马总虫量(头)" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D882_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y10:str:N" />"
							chname="蓟马被害株率（%）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y08/Y02*100";gsjg[gsjg.length]="Y10";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D882_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y11:str:N" />"
							chname="蓟马百株虫量(头)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y09/Y02*100";gsjg[gsjg.length]="Y11";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D882_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y12:str:N" />"
							chname="蚜虫虫株数（株）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D882_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y13:str:N" />"
							chname="蚜虫总虫量(头)" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D882_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y14:str:N" />"
							chname="蚜虫被害株率（%）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y12/Y02*100";gsjg[gsjg.length]="Y14";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D882_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y15:str:N" />"
							chname="蚜虫百株虫量(头)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y13/Y02*100";gsjg[gsjg.length]="Y15";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D882_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y16:str:N" />"
							chname="棉铃虫虫株数（株）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D882_BODY:Y17:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y17:str:N" />"
							chname="棉铃虫总虫量(头)" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D882_BODY:Y18:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y18:str:N" />"
							chname="棉铃虫被害株率（%）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y16/Y02*100";gsjg[gsjg.length]="Y18";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y19" name="D882_BODY:Y19:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y19:str:N" />"
							chname="棉铃虫百株虫量(头)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y17/Y02*100";gsjg[gsjg.length]="Y19";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y20" name="D882_BODY:Y20:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y20:str:N" />"
							chname="草地螟虫株数（株）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y21" name="D882_BODY:Y21:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y21:str:N" />"
							chname="草地螟总虫量(头)" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y22" name="D882_BODY:Y22:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y22:str:N" />"
							chname="草地螟被害株率（%）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y20/Y02*100";gsjg[gsjg.length]="Y22";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y23" name="D882_BODY:Y23:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y23:str:N" />"
							chname="草地螟百株虫量(头)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y21/Y02*100";gsjg[gsjg.length]="Y23";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y24" name="D882_BODY:Y24:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D882_BODY:Y24:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D882_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D882_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
