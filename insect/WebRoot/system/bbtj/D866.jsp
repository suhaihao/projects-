		...
		%><table
			...
			<tr>
				<td colspan=6 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>麦田杂草普查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D866_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D866_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: "
					value="<%=zt%>" /></td>
			</tr>
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>调查面积（平方尺）</b></td>
					<td colspan=15 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>杂草数量（株）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>平均密度（株/平方尺）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>备注</b></td>
				</tr>
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>播娘蒿</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>荠菜</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>打碗花</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>看麦娘</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>葎草</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>灰菜</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>芦苇</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>麦家公</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>麦瓶草</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>罔草</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>野燕麦</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>雀麦</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>节节麦</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>其它</b></td>
					<td colspan=1 rowspan=1
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D866_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D866_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D866_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D866_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D866_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D866_BODY:Y02:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y02:str:N" />"
							chname="调查面积（平方尺）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D866_BODY:Y03:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y03:str:N" />" chname="播娘蒿"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D866_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y04:str:N" />" chname="荠菜"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D866_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y05:str:N" />" chname="打碗花"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D866_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y06:str:N" />" chname="看麦娘"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D866_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y07:str:N" />" chname="葎草"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D866_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y08:str:N" />" chname="灰菜"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D866_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y09:str:N" />" chname="芦苇"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D866_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y10:str:N" />" chname="麦家公"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D866_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y11:str:N" />" chname="麦瓶草"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D866_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y12:str:N" />" chname="罔草"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D866_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y13:str:N" />" chname="野燕麦"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D866_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y14:str:N" />" chname="雀麦"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D866_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y15:str:N" />" chname="节节麦"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D866_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y16:str:N" />" chname="其它"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D866_BODY:Y17:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y17:str:N" />" chname="合计"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y03+Y04+Y05+Y06+Y07+Y08+Y09+Y10+Y11+Y12+Y13+Y14+Y15+Y16";gsjg[gsjg.length]="Y17";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D866_BODY:Y18:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y18:str:N" />"
							chname="平均密度（株/平方尺）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y17/Y02";gsjg[gsjg.length]="Y18";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y19" name="D866_BODY:Y19:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D866_BODY:Y19:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D866_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D866_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: ;font-size:12"
					value="<%=username%>" /></td>
			</tr>
