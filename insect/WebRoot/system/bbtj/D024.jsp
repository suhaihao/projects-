	...
	<form id="f1" name="f1" action="/insect/tjbcsj_t.do?ACT_TYPE=Q<%=zbid%>"
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>三代粘虫省站汇报模式报表(<%=rwsj%>)
				</b><br> <br></td>
			</tr>
			<tr>
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_body">
				 ...
				 <tr>
					<td style="text-align: center;">三代粘虫有虫面积(万亩)</td>
					<td><input style="width: 100%;" name="SDNCYCMJ" type="text"
						value="<%=SDNCYCMJ%>" alertname="三代粘虫有虫面积必须为数字" datatype="number" /></td>
