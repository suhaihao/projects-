		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>粘虫年度发生与预测统计表（按作物分）(<%=rwsj%>)
				</b><br> <br></td>
			</tr>
			<tr>
			...
			<tbody id="zg_body">
				<tr>
					...
					<td><input style="width: 100%;" name="SDNC_FSMJ" type="text"
						value="<%=SDNC_FSMJ%>" alertname="水稻粘虫发生面积必须为数字" datatype="number" onkeyup="fsmj(this)"/></td>
					<td><input style="width: 100%;" name="SDNC_FZMJ" type="text"
						value="<%=SDNC_FZMJ%>" alertname="水稻粘虫防治面积必须为数字" datatype="number" onkeyup="fzmj(this)"/></td>
					...
					<td><input style="width: 100%;" name="SDNC_FSMJ_H" type="text"
						value="<%=SDNC_FSMJ_H%>" alertname="水稻粘虫发生面积下年度发生情况预测必须为数字" datatype="number" onkeyup="fsmj_h(this)"/></td>
					<td><input style="width: 100%;" name="SDNC_ZDFSQY_H" type="text"
						value="<%=SDNC_ZDFSQY_H%>"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">小麦粘虫</td>
					<td><select name="XMNC_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
					<td><input style="width: 100%;" name="XMNC_FSMJ" type="text"
						value="<%=XMNC_FSMJ%>" alertname="小麦粘虫发生面积必须为数字" datatype="number" onkeyup="fsmj(this)"/></td>
					<td><input style="width: 100%;" name="XMNC_FZMJ" type="text"
						value="<%=XMNC_FZMJ%>" alertname="小麦粘虫防治面积必须为数字" datatype="number" onkeyup="fzmj(this)"/></td>
					...
					<td><select name="XMNC_FSCD_H" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
					<td><input style="width: 100%;" name="XMNC_FSMJ_H" type="text"
						value="<%=XMNC_FSMJ_H%>" alertname="小麦粘虫发生面积下年度发生情况预测必须为数字" datatype="number" onkeyup="fsmj_h(this)"/></td>
					<td><input style="width: 100%;" name="XMNC_ZDFSQY_H" type="text"
						value="<%=XMNC_ZDFSQY_H%>"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">玉米粘虫</td>
					<td><select name="YMNC_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
					<td><input style="width: 100%;" name="YMNC_FSMJ" type="text"
						value="<%=YMNC_FSMJ%>" alertname="玉米粘虫发生面积必须为数字" datatype="number" onkeyup="fsmj(this)"/></td>
					<td><input style="width: 100%;" name="YMNC_FZMJ" type="text"
						value="<%=YMNC_FZMJ%>" alertname="玉米粘虫防治面积必须为数字" datatype="number" onkeyup="fzmj(this)"/></td>
					...
					<td><select name="YMNC_FSCD_H" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
					<td><input style="width: 100%;" name="YMNC_FSMJ_H" type="text"
						value="<%=YMNC_FSMJ_H%>" alertname="玉米粘虫发生面积下年度发生情况预测必须为数字" datatype="number" onkeyup="fsmj_h(this)"/></td>
					<td><input style="width: 100%;" name="YMNC_ZDFSQY_H" type="text"
						value="<%=YMNC_ZDFSQY_H%>"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">其他粮作粘虫</td>
					<td><select name="QTLZNC_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
					<td><input style="width: 100%;" name="QTLZNC_FSMJ" type="text"
						value="<%=QTLZNC_FSMJ%>" alertname="其他粮作粘虫发生面积必须为数字" datatype="number" onkeyup="fsmj(this)"/></td>
					<td><input style="width: 100%;" name="QTLZNC_FZMJ" type="text"
						value="<%=QTLZNC_FZMJ%>" alertname="其他粮作粘虫防治面积必须为数字" datatype="number" onkeyup="fzmj(this)"/></td>
					...
					<td><select name="QTLZNC_FSCD_H" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
					<td><input style="width: 100%;" name="QTLZNC_FSMJ_H" type="text"
						value="<%=QTLZNC_FSMJ_H%>" alertname="其他粮作粘虫发生面积下年度发生情况预测必须为数字" datatype="number" onkeyup="fsmj_h(this)"/></td>
