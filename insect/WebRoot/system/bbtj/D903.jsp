		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>设施蔬菜病害调查报表（区县）(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D903_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D903_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>棚主姓名或棚编号</b></td>
					<td colspan=1 rowspan=2
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D903_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D903_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D903_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D903_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D903_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D903_BODY:Y02:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y02:str:S" />" chname="基地"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D903_BODY:Y03:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y03:str:S" />"
							chname="棚主姓名或棚编号" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y04" other="chname='茬口及棚种类' nullable='no'"
								name="D903_BODY:Y04:str:S" datamember=" dsys11 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D903_BODY:Y05:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_SCZL' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D903_BODY:Y06:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y06:str:S" />" chname="品种"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D903_BODY:Y07:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D903_BODY:Y07:str:D" />" class="Wdate"
							onFocus="WdatePicker({skin:'whyGreen', maxDate: '%y-%M-%d' })" onkeyup="changeiput(this)" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D903_BODY:Y08:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D903_BODY:Y08:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D903_BODY:Y09:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_SCSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y10" other="zi='Y05' chname='病害名称' nullable='no'"
								name="D903_BODY:Y10:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_SCBHZL' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D903_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y11:str:N" />" chname="调查株数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y17+Y18+Y19+Y20+Y21";gsjg[gsjg.length]="Y11";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D903_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y12:str:N" />" chname="病株数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y18+Y19+Y20+Y21";gsjg[gsjg.length]="Y12";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D903_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y13:str:N" />" chname="病株率%"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y12/Y11*100";gsjg[gsjg.length]="Y13";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D903_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y14:str:N" />" chname="调查果数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D903_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y15:str:N" />" chname="病果数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D903_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y16:str:N" />" chname="病果率%"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y15/Y14*100";gsjg[gsjg.length]="Y16";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D903_BODY:Y17:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y17:str:N" />" chname="0级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D903_BODY:Y18:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y18:str:N" />" chname="1级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y19" name="D903_BODY:Y19:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y19:str:N" />" chname="2级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y20" name="D903_BODY:Y20:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y20:str:N" />" chname="3级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y21" name="D903_BODY:Y21:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y21:str:N" />" chname="4级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y22" name="D903_BODY:Y22:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y22:str:N" />" chname="病情指数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y18+Y19*2+Y20*3+Y21*4)*100";gsjg[gsjg.length]="Y22";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y23" name="D903_BODY:Y23:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D903_BODY:Y23:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D903_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width: ;height: ;font-size:12"
					value="<%=username%>" /></td>
				<td colspan=1 rowspan=1
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D903_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
