		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>露地蔬菜病害调查报表（基点）(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D897_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D897_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D897_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D897_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D897_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D897_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D897_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D897_BODY:Y02:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D897_BODY:Y02:str:S" />" chname="基地"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y03" other="chname='茬口' nullable='no'"
								name="D897_BODY:Y03:str:S" datamember=" dsys11 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D897_BODY:Y04:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_SCZL' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D897_BODY:Y05:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D897_BODY:Y05:str:S" />" chname="品种"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D897_BODY:Y06:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D897_BODY:Y06:str:D" />" class="Wdate"
							onFocus="WdatePicker()" onkeyup="changeiput(this)" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D897_BODY:Y07:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D897_BODY:Y07:str:D" />" class="Wdate"
							onFocus="WdatePicker()" onkeyup="changeiput(this)" chname="定植时间"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y08" other="zi='Y04' chname='生育期' nullable='no'"
								name="D897_BODY:Y08:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_SCSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y09" other="zi='Y04' chname='病害名称' nullable='no'"
								name="D897_BODY:Y09:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_SCBHZL' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D897_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D897_BODY:Y10:str:N" />" chname="调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D897_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D897_BODY:Y11:str:N" />" chname="病株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D897_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D897_BODY:Y12:str:N" />" chname="病株率（％）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y11/Y10*100";gsjg[gsjg.length]="Y12";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D897_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D897_BODY:Y13:str:N" />" chname="调查果数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D897_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D897_BODY:Y14:str:N" />" chname="病果数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D897_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D897_BODY:Y15:str:N" />" chname="病果率（％）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y14/Y13*100";gsjg[gsjg.length]="Y15";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D897_BODY:Y16:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D897_BODY:Y16:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D897_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width: ;height: ;font-size:12"
					value="<%=username%>" /></td>
				<td colspan=1 rowspan=1
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D897_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
