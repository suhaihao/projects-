...
$("#okUp").click(function(){
	var path = $("#file").val();
	var delid = document.getElementsByName("delid")[0].value;
	if (path.indexOf(".xls") > 0) {
		var _con_ = "";
		$("input[name*='_HEAD']").each(function(){
			_con_ += $(this).attr("name") + "," + $(this).val() + "@";
			});
		$("#f2").attr("action", $("#f2").attr("action") + "&hd=" + _con_+"&lujing="+path+"&deltid="+delid);
		$("#f2").submit();
		} else {alert("请选择Excel格式文件");}});
		...
		%><table
			...
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>麦蚜数量普查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D849_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:200;height: "
					value="<%=bmmc%>" /></td>
				<td colspan=1 rowspan=1 style="font-size:12;width:400;height: "><b>
				</b></td>
				<td colspan=1 rowspan=1 style="font-size:12;width:50;height: "><b>状态</b></td>
				<td colspan=1 rowspan=1><input type="hidden"
					name="D849_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>有蚜株数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>有蚜株率%</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>蚜虫数(头)</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>百株蚜量(头)</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>折算百株天敌单位数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>备注</b></td>
				</tr>
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>有翅</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>无翅</b></td>
					<td colspan=1 rowspan=1
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D849_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D849_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D849_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D849_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D849_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02" other="chname='生育期' nullable='no'"
								name="D849_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_XMSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D849_BODY:Y03:N"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D849_BODY:Y03:str:N" />" chname="调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D849_BODY:Y04:N"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D849_BODY:Y04:str:N" />" chname="有蚜株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D849_BODY:Y05:N"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D849_BODY:Y05:str:N" />" chname="有蚜株率%"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y04/Y03*100";gsjg[gsjg.length]="Y05";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D849_BODY:Y06:N"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D849_BODY:Y06:str:N" />"
							chname="有翅蚜虫数(头)" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D849_BODY:Y07:N"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D849_BODY:Y07:str:N" />"
							chname="无翅蚜虫数(头)" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D849_BODY:Y08:N"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D849_BODY:Y08:str:N" />"
							chname="合计蚜虫数(头)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y06+Y07";gsjg[gsjg.length]="Y08";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D849_BODY:Y09:N"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D849_BODY:Y09:str:N" />" chname="百株蚜量（头）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y06+Y07)*100/Y03";gsjg[gsjg.length]="Y09";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D849_BODY:Y11:N"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D849_BODY:Y11:str:N" />" chname="百株天敌数量"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D849_BODY:Y13:S"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D849_BODY:Y13:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D849_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D849_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
