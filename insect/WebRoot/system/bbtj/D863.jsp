		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>地下害虫黑光灯诱测成虫记载表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D863_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D863_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:200;height: "
					value="<%=zt%>" /></td>
			</tr>
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>蝼蛄（头）</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>金针虫（头）</b></td>
					<td colspan=7 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>金龟子类（头）</b></td>
					<td colspan=5 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>地老虎（头）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>备注</b></td>
				</tr>
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>东方</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>华北</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>细胸</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>沟</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>大黑</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>铜绿</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>暗黑</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>黄褐</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>黑绒</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>其他</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>八字地老虎</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>小地老虎</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>黄地老虎</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width:40;height: "><b>大地老虎</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计</b></td>
				</tr>
			</tbody>
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D863_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D863_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D863_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D863_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D863_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D863_BODY:Y02:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y02:str:N" />" chname="东方蝼蛄"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D863_BODY:Y03:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y03:str:N" />" chname="华北蝼蛄"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D863_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y04:str:N" />" chname="蝼蛄合计"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y02+Y03";gsjg[gsjg.length]="Y04";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D863_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y05:str:N" />" chname="细胸金针虫"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D863_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y06:str:N" />" chname="沟金针虫"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D863_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y07:str:N" />" chname="金针虫合计"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y05+Y06";gsjg[gsjg.length]="Y07";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D863_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y08:str:N" />" chname="大黑金龟子类"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D863_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y09:str:N" />" chname="铜绿金龟子类"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D863_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y10:str:N" />" chname="暗黑金龟子类"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D863_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y11:str:N" />" chname="黄褐金龟子类"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D863_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y12:str:N" />" chname="黑绒金龟子类"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D863_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y13:str:N" />" chname="其他金龟子类"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D863_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y14:str:N" />" chname="金龟子类合计"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y08+Y09+Y10+Y11+Y12+Y13";gsjg[gsjg.length]="Y14";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D863_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y15:str:N" />" chname="八字地老虎"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D863_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y16:str:N" />" chname="小地老虎"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D863_BODY:Y17:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y17:str:N" />" chname="黄地老虎"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D863_BODY:Y18:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y18:str:N" />" chname="大地老虎"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y19" name="D863_BODY:Y19:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y19:str:N" />" chname="地老虎合计"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y15+Y16+Y17+Y18";gsjg[gsjg.length]="Y19";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y20" name="D863_BODY:Y20:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D863_BODY:Y20:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D863_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width: ;height: ;font-size:12"
					value="<%=username%>" /></td>
				<td colspan=1 rowspan=1
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D863_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
