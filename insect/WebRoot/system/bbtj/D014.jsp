...
<body>
	<%
		...
		if (!bbzt.equals("0")) {
			...
			try {
				String sql = "select * from D014 where jfid=" + jfid;
				...
				while (rsbody.next()) {
					...
					EDMLC_ZDFSQY = rsbody.getString("EDMLC_ZDFSQY")==null?"":rsbody.getString("EDMLC_ZDFSQY");
					EDMLC_FSCD_H = rsbody.getString("EDMLC_FSCD_H")==null?"":rsbody.getString("EDMLC_FSCD_H");
					EDMLC_FSMJ_H = rsbody.getString("EDMLC_FSMJ_H")==null?"":rsbody.getString("EDMLC_FSMJ_H");
					EDMLC_ZDFSQY_H = rsbody.getString("EDMLC_ZDFSQY_H")==null?"":rsbody.getString("EDMLC_ZDFSQY_H");
					...
					FDMLC_ZDFSQY = rsbody.getString("FDMLC_ZDFSQY")==null?"":rsbody.getString("FDMLC_ZDFSQY");
					FDMLC_FSCD_H = rsbody.getString("FDMLC_FSCD_H")==null?"":rsbody.getString("FDMLC_FSCD_H");
					FDMLC_FSMJ_H = rsbody.getString("FDMLC_FSMJ_H")==null?"":rsbody.getString("FDMLC_FSMJ_H");
					FDMLC_ZDFSQY_H = rsbody.getString("FDMLC_ZDFSQY_H")==null?"":rsbody.getString("FDMLC_ZDFSQY_H");
					...
					YMWBMYBB_ZDFSQY_H = rsbody.getString("YMWBMYBB_ZDFSQY_H")==null?"":rsbody.getString("YMWBMYBB_ZDFSQY_H");
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>玉米病虫害跨年预测表(<%=rwsj%>)
				</b><br> <br></td>
			</tr>
			<tr>
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>当年发生情况统计</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>下年发生趋势预测</b></td>
				</tr>
				<tr>
			...
			<tbody id="zg_body">
				<tr>
					...
					<td><select name="YDYMM_FSCD_H" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="EDYMM_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="SDYMM_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="EDMLC_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
					<td><input style="width: 100%;" name="EDMLC_FSMJ" type="text"
						value="<%=EDMLC_FSMJ%>" alertname="二代棉铃虫发生面积必须为数字" datatype="number" onkeyup="fsmj(this)"/></td>
					<td style="text-align: center;">\</td>
					<td><select name="EDMLC_FSCD_H" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
					<td><input style="width: 100%;" name="EDMLC_FSMJ_H" type="text"
						value="<%=EDMLC_FSMJ_H%>" alertname="二代棉铃虫发生面积中后期必须为数字" datatype="number" onkeyup="fsmj(this)"/></td>
			        <td style="text-align: center;">\</td>
				</tr>
				<tr>
					<td style="text-align: center;">三代棉铃虫</td>
					<td><select name="SDMLC_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="FDMLC_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
					<td><input style="width: 100%;" name="FDMLC_FSMJ" type="text"
						value="<%=FDMLC_FSMJ%>" alertname="四代棉铃虫发生面积必须为数字" datatype="number" onkeyup="fsmj(this)"/></td>
				    <td style="text-align: center;">\</td>
					<td><select name="FDMLC_FSCD_H" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
					<td><input style="width: 100%;" name="FDMLC_FSMJ_H" type="text"
						value="<%=FDMLC_FSMJ_H%>" alertname="四代棉铃虫发生面积中后期必须为数字" datatype="number" onkeyup="fsmj(this)"/></td>
					<td style="text-align: center;">\</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><select name="DBB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="XBB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="HBB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="YMWBMYBB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="WKB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="SHSB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="XB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="LHFB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="CSB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="DFB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				    ...
				    <td style="text-align: center;">\</td>
					<td style="text-align: center;"><select name="DFB_FSCD_H" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
				...
				<tr>
					...
					<td><select name="QTB_FSCD" style="width: 100%"><option value="">请选择</option><%=onpent%></select></td>
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_body">
				<tr>
					...
					<td><label><%=YDYMM_FSCD_H%>级</label></td>
				...
				<tr>
					...
					<td style="text-align: center;">\</td>
					<td><label><%=EDMLC_FSCD_H%>级</label></td>
					<td><label><%=EDMLC_FSMJ_H%></label></td>
					<td style="text-align: center;">\</td>
				</tr>
				<tr>
					<td style="text-align: center;">三代棉铃虫</td>
				...
				<tr>
					...
					<td style="text-align: center;">\</td>
					<td><label><%=FDMLC_FSCD_H%>级</label></td>
					<td><label><%=FDMLC_FSMJ_H%></label></td>
					<td style="text-align: center;">\</td>
				</tr>
				<tr>
					<td style="text-align: center;">草地螟</td>
				...
				<tr>
					...
					<td style="text-align: center;">\</td>
					<td><label><%=DFB_FSCD_H%>级</label></td>
...
$("#btnUpload").click(function(){
	...
	$(function() {
		...
		xzsel('YDYMM_FSCD_H','<%=YDYMM_FSCD_H%>');
		...
		xzsel('EDMLC_FSCD_H','<%=EDMLC_FSCD_H%>');
		xzsel('SDMLC_FSCD','<%=SDMLC_FSCD%>');
		xzsel('FDMLC_FSCD','<%=FDMLC_FSCD%>');
		xzsel('FDMLC_FSCD_H','<%=FDMLC_FSCD_H%>');
	...
	function fsmj(obj) {
		...
		if (!isNaN(obj.value)) {
			...
			if ($("input[name='EDMLC_FSMJ_H']").val() != "") {
				zh_h = zh_h + parseFloat($("input[name='EDMLC_FSMJ_H']").val());
			}
			...
			if ($("input[name='FDMLC_FSMJ_H']").val() != "") {
				zh_h = zh_h + parseFloat($("input[name='FDMLC_FSMJ_H']").val());
			}
			...
			if (hz == "B") {
				...
				if ($("input[name='EDMLC_FSMJ_H']").val() != "") {
					ch_h = ch_h + parseFloat($("input[name='EDMLC_FSMJ_H']").val());
				}
				if ($("input[name='SDMLC_FSMJ']").val() != "") {
				...
				if ($("input[name='FDMLC_FSMJ_H']").val() != "") {
					ch_h = ch_h + parseFloat($("input[name='FDMLC_FSMJ_H']").val());
				}
				if ($("input[name='CDM_FSMJ']").val() != "") {
