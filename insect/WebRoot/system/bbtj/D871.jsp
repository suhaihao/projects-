		...
		%><table
			...
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>二代粘虫田间卵、幼虫密度调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D871_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:90;height: "
					value="<%=bmmc%>" /></td>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D871_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>取样单位</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>作物种类</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>取样数(m2或株)</b></td>
					<td colspan=6 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>卵量调查</b></td>
					<td colspan=8 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>幼虫调查</b></td>
					<td colspan=1 rowspan=3
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>备注</b></td>
				</tr>
				<tr>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>总卵块数（块）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>检查卵块数（块）</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>单块卵粒数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>平均卵量(粒/m2)</b></td>
					<td colspan=7 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>各龄幼虫数（头）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>幼虫密度(头/
							百株或m2)</b></td>
				</tr>
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>最多</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>最少</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>平均</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>一龄</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>二龄</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>三龄</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>四龄</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>五龄</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>六龄</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>总虫量</b></td>
				</tr>
			</tbody>
			<tbody id="zg_body">
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D871_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D871_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D871_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D871_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D871_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02"
								other="onchange='xuanze(this)' fu='Y19' chname='作物种类' nullable='no'"
								name="D871_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='BBNCTJ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y19" other="zi='Y02' chname='取样单位' nullable='no'"
								name="D871_BODY:Y19:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_NCQYDW' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D871_BODY:Y03:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y03:str:N" />"
							chname="取样数(m2或株)" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D871_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y04:str:N" />" chname="总卵块数（块）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D871_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y05:str:N" />"
							chname="检查卵块数（块）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D871_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y06:str:N" />" chname="单块卵粒数最多"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D871_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y07:str:N" />" chname="单块卵粒数最少"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D871_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y08:str:N" />" chname="单块卵粒数平均"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D871_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y09:str:N" />"
							chname="平均卵量(粒/m2)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y04/Y03";gsjg[gsjg.length]="Y09";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D871_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y10:str:N" />"
							chname="一龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D871_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y11:str:N" />"
							chname="二龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D871_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y12:str:N" />"
							chname="三龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D871_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y13:str:N" />"
							chname="四龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D871_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y14:str:N" />"
							chname="五龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D871_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y15:str:N" />"
							chname="六龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D871_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y16:str:N" />" chname="总幼虫数（头）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y10+Y11+Y12+Y13+Y14+Y15";gsjg[gsjg.length]="Y16";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D871_BODY:Y17:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y17:str:N" />"
							chname="幼虫密度(头/ 百株或m2)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y16/Y03";gsjg[gsjg.length]="Y17";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D871_BODY:Y18:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D871_BODY:Y18:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D871_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
