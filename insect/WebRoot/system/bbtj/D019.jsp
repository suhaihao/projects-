		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>	二点委夜蛾二代幼虫发生趋势预测表 (<%=rwsj%>)
				</b><br> <br></td>
			</tr>
			<tr>
			...
			<tbody id="zg_head">
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>夏玉米播期比常年早晚天数（±天）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>苗期与幼虫发生吻合度（好/一般/差）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>小麦秸秆还田面积比（%）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>玉米田覆盖物厚度与常年比（高/中/低）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>预计发生程度</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>预计发生面积（万亩）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>预计发生区域</b></td>
					<td colspan=1 rowspan=1
			...
			<tbody id="zg_body">
				 <tr>
					<td><input style="width: 100%;" name="XYMBQBCNZWTS" type="text"
						value="<%=XYMBQBCNZWTS%>" alertname="夏玉米播期比常年早晚天数必须为数字" datatype="number" /></td>
					<td><input style="width: 100%;" name="YMYYCFSWHD" type="text"
						value="<%=YMYYCFSWHD%>" /></td>
					<td><input style="width: 100%;" name="XMJGHTMJB" type="text"
						value="<%=XMJGHTMJB%>" alertname="小麦秸秆还田面积比必须为数字" datatype="number" /></td>
					...
					<td><input style="width: 100%;" name="YJFSMJ" type="text"
						value="<%=YJFSMJ%>" alertname="预计发生面积必须为数字" datatype="number" /></td>
					<td>\</td>
					<td>\</td>
				</tr>
			</tbody>
