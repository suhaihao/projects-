		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_body">
				 <tr>
					...
					<td><input style="width: 100%;" name="YDDCC_NTFSMJ" type="text"
						value="<%=YDDCC_NTFSMJ%>" alertname="越冬代成虫农田发生面积必须为数字" datatype="number" /></td>
					<td style="text-align: center;">二代幼虫草场发生面积（万亩）</td>
					<td><input style="width: 100%;" name="EDYC_CCFSMJ" type="text"
						value="<%=EDYC_CCFSMJ%>" alertname="二代幼虫草场发生面积必须为数字" datatype="number"/></td>
				</tr>
				 <tr>
					<td style="text-align: center;">越冬代成虫草场发生面积（万亩）</td>
					<td><input style="width: 100%;" name="YDDCC_CCFSMJ" type="text"
						value="<%=YDDCC_CCFSMJ%>" alertname="越冬代成虫草场发生面积必须为数字" datatype="number" /></td>
				...
				<tr>
					...
					<td><input style="width: 100%;" name="EDYC_FSZMJ" type="text"
						value="<%=EDYC_FSZMJ%>" alertname="二代幼虫发生总面积必须为数字" datatype="number"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">越冬代成虫发生总面积（万亩）</td>
					<td><input style="width: 100%;" name="YDDCC_FSZMJ" type="text"
						value="<%=YDDCC_FSZMJ%>" alertname="越冬代成虫发生总面积必须为数字" datatype="number" /></td>
					<td style="text-align: center;">二代幼虫农田平均密度（头/m2）</td>
					<td><input style="width: 100%;" name="EDYC_NTPJMD" type="text"
						value="<%=EDYC_NTPJMD%>" alertname="二代幼虫农田平均密度必须为数字" datatype="number"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">一代幼虫农田发生面积（万亩）</td>
					<td><input style="width: 100%;" name="YDYC_NTFSMJ" type="text"
						value="<%=YDYC_NTFSMJ%>" alertname="一代幼虫农田发生面积必须为数字" datatype="number" /></td>
					<td style="text-align: center;">二代幼虫农田防治面积（万亩）</td>
					<td><input style="width: 100%;" name="EDYC_NTFZMJ" type="text"
						value="<%=EDYC_NTFZMJ%>" alertname="二代幼虫农田防治面积必须为数字" datatype="number"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">一代幼虫草场发生面积（万亩）</td>
					<td><input style="width: 100%;" name="YDYC_CCFSMJ" type="text"
						value="<%=YDYC_CCFSMJ%>" alertname="一代幼虫草场发生面积必须为数字" datatype="number" /></td>
					<td style="text-align: center;">二代幼虫草场防治面积（万亩）</td>
					<td><input style="width: 100%;" name="EDYC_CCFZMJ" type="text"
						value="<%=EDYC_CCFZMJ%>" alertname="二代幼虫草场防治面积必须为数字" datatype="number"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input style="width: 100%;" name="YDYC_FSZMJ" type="text"
						value="<%=YDYC_FSZMJ%>" alertname="一代幼虫发生总面积必须为数字" datatype="number" /></td>
					<td style="text-align: center;">二代成虫农田发生面积（万亩）</td>
					<td><input style="width: 100%;" name="EDCC_NTFZMJ" type="text"
						value="<%=EDCC_NTFZMJ%>" alertname="二代成虫农田发生面积必须为数字" datatype="number"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">一代幼虫农田平均密度（头/m2）</td>
					<td><input style="width: 100%;" name="YDYC_NTPJMD" type="text"
						value="<%=YDYC_NTPJMD%>" alertname="一代幼虫农田平均密度必须为数字" datatype="number" /></td>
					<td style="text-align: center;">二代成虫草场发生面积（万亩）</td>
					<td><input style="width: 100%;" name="EDCC_CCFSMJ" type="text"
						value="<%=EDCC_CCFSMJ%>" alertname="二代成虫草场发生面积必须为数字" datatype="number"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">一代幼虫农田防治面积（万亩）</td>
					<td><input style="width: 100%;" name="YDYC_NTFZMJ" type="text"
						value="<%=YDYC_NTFZMJ%>" alertname="一代幼虫农田防治面积必须为数字" datatype="number" /></td>
					<td style="text-align: center;">二代成虫林地发生面积（万亩）</td>
					<td>\</td>
				</tr>
				<tr>
					<td style="text-align: center;">一代幼虫草场防治面积（万亩）</td>
					<td><input style="width: 100%;" name="YDYC_CCFZMJ" type="text"
						value="<%=YDYC_CCFZMJ%>" alertname="一代幼虫草场防治面积必须为数字" datatype="number" /></td>
					<td style="text-align: center;">二代成虫发生总面积（万亩）</td>
					<td><input style="width: 100%;" name="EDCC_FSZMJ" type="text"
						value="<%=EDCC_FSZMJ%>" alertname="二代成虫发生总面积必须为数字" datatype="number"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">一代幼虫林地防治面积（万亩）</td>
					<td>\</td>
					<td style="text-align: center;">三代幼虫农田发生面积（万亩）</td>
					<td><input style="width: 100%;" name="SDYC_NTFSMJ" type="text"
						value="<%=SDYC_NTFSMJ%>" alertname="三代幼虫农田发生面积必须为数字" datatype="number"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">一代成虫农田发生面积（万亩）</td>
					<td><input style="width: 100%;" name="YDCC_NTFSMJ" type="text"
						value="<%=YDCC_NTFSMJ%>" alertname="一代成虫农田发生面积必须为数字" datatype="number" /></td>
					<td style="text-align: center;">三代幼虫草场发生面积（万亩）</td>
					<td><input style="width: 100%;" name="SDYC_CCFSMJ" type="text"
						value="<%=SDYC_CCFSMJ%>" alertname="三代幼虫草场发生面积必须为数字" datatype="number"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">一代成虫草场发生面积（万亩）</td>
					<td><input style="width: 100%;" name="YDCC_CCFSMJ" type="text"
						value="<%=YDCC_CCFSMJ%>" alertname="一代成虫草场发生面积必须为数字" datatype="number" /></td>
				...
				<tr>
					...
					<td><input style="width: 100%;" name="SDYC_NTPJSL" type="text"
						value="<%=SDYC_NTPJSL%>" alertname="三代幼虫农田平均数量必须为数字" datatype="number"/></td>
				</tr>
				<tr>
					<td style="text-align: center;">一代成虫发生总面积（万亩） </td>
					<td><input style="width: 100%;" name="YDCC_FSZMJ" type="text"
						value="<%=YDCC_FSZMJ%>" alertname="一代成虫发生总面积必须为数字" datatype="number" /></td>
					<td style="text-align: center;">三代幼虫农田防治面积（万亩）</td>
					<td><input style="width: 100%;" name="SDYC_NTFZMJ" type="text"
						value="<%=SDYC_NTFZMJ%>" alertname="三代幼虫农田防治面积必须为数字" datatype="number"/></td>
				</tr>
				<tr>
					<td rowspan="2" style="text-align: center;">二代幼虫农田发生面积（万亩） </td>
					<td rowspan="2"><input style="width: 100%;" name="EDYC_NTFSMJ" type="text"
						value="<%=EDYC_NTFSMJ%>" alertname="二代幼虫农田发生面积必须为数字" datatype="number" /></td>
					<td style="text-align: center;">三代幼虫草场防治面积（万亩）</td>
					<td><input style="width: 100%;" name="SDYC_CCFZMJ" type="text"
						value="<%=SDYC_CCFZMJ%>" alertname="三代幼虫草场防治面积必须为数字" datatype="number"/></td>
				</tr>
				<tr>
