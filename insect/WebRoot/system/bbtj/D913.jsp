		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width:400;height: "><b>二点委夜蛾发生为害调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D913_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D913_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: "
					value="<%=zt%>" /></td>
			</tr>
			...
			<tbody id="zg_head">
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>调查时间</b></td>
					<td colspan=1 rowspan=1
					...
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>调查作物</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>作物生育期</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>取样面积（m2）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>幼虫数（头）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>蛹数（头）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>幼虫密度
							（头/m2）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>蛹密度（头/m2）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计虫量（头/m2）</b></td>
					<td colspan=1 rowspan=1
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D913_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D913_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D913_BODY:DCRQ:str:D" />" class="Wdate"
							onFocus="WdatePicker({skin:'whyGreen', maxDate: '%y-%M-%d' })" onkeyup="changeiput(this)" chname="调查时间"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="XZ"
								other="onchange='xuanze(this)' fu='Y01' chname='乡镇' nullable='no'"
								name="D913_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D913_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02" other="chname='调查作物' nullable='no'"
								name="D913_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='BBYMMZW' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y03" other="chname='作物生育期' nullable='no'"
								name="D913_BODY:Y03:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_YMSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D913_BODY:Y04:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D913_BODY:Y04:str:N" />"
							chname="取样面积（m2）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D913_BODY:Y05:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D913_BODY:Y05:str:N" />" chname="幼虫数（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D913_BODY:Y06:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D913_BODY:Y06:str:N" />" chname="蛹数（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D913_BODY:Y07:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D913_BODY:Y07:str:N" />"
							chname="幼虫密度 （头/m2）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" Y05/Y04";gsjg[gsjg.length]="Y07";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D913_BODY:Y08:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D913_BODY:Y08:str:N" />"
							chname="蛹密度（头/m2）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" Y06/Y04";gsjg[gsjg.length]="Y08";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D913_BODY:Y09:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D913_BODY:Y09:str:N" />"
							chname="合计虫量（头/m2）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" (Y05+Y06)/Y04";gsjg[gsjg.length]="Y09";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D913_BODY:Y10:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D913_BODY:Y10:str:N" />" chname="调查株数（株）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D913_BODY:Y11:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D913_BODY:Y11:str:N" />" chname="被害株数（株）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D913_BODY:Y12:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D913_BODY:Y12:str:N" />" chname="被害株率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]=" Y11/Y10";gsjg[gsjg.length]="Y12";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D913_BODY:Y13:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D913_BODY:Y13:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D913_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D913_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: ;font-size:12"
					value="<%=username%>" /></td>
			</tr>
