		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>二代粘虫雌蛾卵巢发育进度调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D869_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D869_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D869_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D869_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D869_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D869_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D869_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D869_BODY:Y02:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y02:str:N" />" chname="检查头数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D869_BODY:Y03:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y03:str:N" />"
							chname="卵巢发育一级头数" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D869_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y04:str:N" />" chname="卵巢发育一级%"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y03/Y02*100";gsjg[gsjg.length]="Y04";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D869_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y05:str:N" />"
							chname="卵巢发育二级头数" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D869_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y06:str:N" />" chname="卵巢发育二级%"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y05/Y02*100";gsjg[gsjg.length]="Y06";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D869_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y07:str:N" />"
							chname="卵巢发育三级头数" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D869_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y08:str:N" />" chname="卵巢发育三级%"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y07/Y02*100";gsjg[gsjg.length]="Y08";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D869_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y09:str:N" />"
							chname="卵巢发育四级头数" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D869_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y10:str:N" />" chname="卵巢发育四级%"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y09/Y02*100";gsjg[gsjg.length]="Y10";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D869_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y11:str:N" />"
							chname="卵巢发育五级头数" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D869_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y12:str:N" />" chname="卵巢发育五级%"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y11/Y02*100";gsjg[gsjg.length]="Y12";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D869_BODY:Y13:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D869_BODY:Y13:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D869_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D869_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
