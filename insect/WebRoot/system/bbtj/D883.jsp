		...
		%><table
			...
			<tr>
				<td colspan=6 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>玉米田杂草种类、密度调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D883_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D883_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
			...
			<tbody id="zg_head">
				...
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>马唐</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>稗草</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>苋</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>葎草</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>苘麻</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>狗尾草</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>野高粱</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>其他</b></td>
					<td colspan=1 rowspan=1
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D883_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D883_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D883_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D883_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D883_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D883_BODY:Y02:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y02:str:N" />"
							chname="调查面积（平方尺）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D883_BODY:Y03:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y03:str:N" />" chname="马唐"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D883_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y04:str:N" />" chname="稗草"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D883_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y05:str:N" />" chname="苋"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D883_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y06:str:N" />" chname="葎草"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D883_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y07:str:N" />" chname="苘麻"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D883_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y08:str:N" />" chname="狗尾草"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D883_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y09:str:N" />" chname="野高粱"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D883_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y10:str:N" />" chname="其他"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D883_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y11:str:N" />" chname="合计"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y03+Y04+Y05+Y06+Y07+Y08+Y09+Y10";gsjg[gsjg.length]="Y11";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D883_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y12:str:N" />"
							chname="平均密度（株/平方尺）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y11/Y02";gsjg[gsjg.length]="Y12";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D883_BODY:Y13:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D883_BODY:Y13:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D883_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D883_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
