	...
	<form id="f1" name="f1" action="/insect/sjtb/add_ht.jsp" method="post">
		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>露地大白菜病害调查报表(区县)(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D912_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D912_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=8 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>霜霉病</b></td>
					<td colspan=8 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>黑腐病</b></td>
					<td colspan=8 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>黑斑病</b></td>
					<td colspan=8 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>细菌性角斑病</b></td>
					<td colspan=2 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>软腐病</b></td>
					<td colspan=2 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>病毒病</b></td>
					<td colspan=1 rowspan=3
				...
				<tr>
					...
					<td colspan=5 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>各级病株数（株）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>病情指数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>病株数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>病株率（％）</b></td>
				...
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>0级</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>1级</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>2级</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>3级</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>4级</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>0级</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>1级</b></td>
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D912_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D912_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D912_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D912_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D912_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D912_BODY:Y02:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y02:str:S" />" chname="品种"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D912_BODY:Y03:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D912_BODY:Y03:str:D" />" class="Wdate"
							onFocus="WdatePicker({skin:'whyGreen', maxDate: '%y-%M-%d' })" onkeyup="changeiput(this)" chname="播种时间"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y04" other="chname='生育期' nullable='no'"
								name="D912_BODY:Y04:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_DBCSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D912_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y05:str:N" />" chname="调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D912_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y06:str:N" />" chname="霜霉病病株数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y09+Y10+Y11+Y12";gsjg[gsjg.length]="Y06";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D912_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y07:str:N" />"
							chname="霜霉病病株率（％）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y06/Y05*100";gsjg[gsjg.length]="Y07";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D912_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y08:str:N" />" chname="霜霉病0级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D912_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y09:str:N" />" chname="霜霉病1级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D912_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y10:str:N" />" chname="霜霉病2级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D912_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y11:str:N" />" chname="霜霉病3级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D912_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y12:str:N" />" chname="霜霉病4级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D912_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y13:str:N" />" chname="霜霉病病情指数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y09+Y10*2+Y11*3+Y12*4)*100";gsjg[gsjg.length]="Y13";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D912_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y14:str:N" />" chname="黑腐病病株数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y17+Y18+Y19+Y20";gsjg[gsjg.length]="Y14";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D912_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y15:str:N" />"
							chname="黑腐病病株率（％）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y14/Y05*100";gsjg[gsjg.length]="Y15";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D912_BODY:Y16:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y16:str:N" />" chname="黑腐病0级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D912_BODY:Y17:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y17:str:N" />" chname="黑腐病1级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y18" name="D912_BODY:Y18:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y18:str:N" />" chname="黑腐病2级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y19" name="D912_BODY:Y19:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y19:str:N" />" chname="黑腐病3级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y20" name="D912_BODY:Y20:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y20:str:N" />" chname="黑腐病4级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y21" name="D912_BODY:Y21:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y21:str:N" />" chname="黑腐病病情指数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y17+Y18*2+Y19*3+Y20*4)*100";gsjg[gsjg.length]="Y21";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y22" name="D912_BODY:Y22:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y22:str:N" />" chname="黑斑病病株数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y25+Y26+Y27+Y28";gsjg[gsjg.length]="Y22";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y23" name="D912_BODY:Y23:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y23:str:N" />"
							chname="黑斑病病株率（％）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y22/Y05*100";gsjg[gsjg.length]="Y23";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y24" name="D912_BODY:Y24:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y24:str:N" />" chname="黑斑病0级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y25" name="D912_BODY:Y25:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y25:str:N" />" chname="黑斑病1级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y26" name="D912_BODY:Y26:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y26:str:N" />" chname="黑斑病2级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y27" name="D912_BODY:Y27:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y27:str:N" />" chname="黑斑病3级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y28" name="D912_BODY:Y28:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y28:str:N" />" chname="黑斑病4级"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y29" name="D912_BODY:Y29:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y29:str:N" />" chname="黑斑病病情指数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y25+Y26*2+Y27*3+Y28*4)*100";gsjg[gsjg.length]="Y29";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y30" name="D912_BODY:Y30:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y30:str:N" />"
							chname="细菌性角斑病病株数" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y33+Y34+Y35+Y36";gsjg[gsjg.length]="Y30";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y31" name="D912_BODY:Y31:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y31:str:N" />"
							chname="细菌性角斑病病株率（％）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y30/Y05*100";gsjg[gsjg.length]="Y31";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y32" name="D912_BODY:Y32:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y32:str:N" />"
							chname="细菌性角斑病0级" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y33" name="D912_BODY:Y33:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y33:str:N" />"
							chname="细菌性角斑病1级" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y34" name="D912_BODY:Y34:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y34:str:N" />"
							chname="细菌性角斑病2级" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y35" name="D912_BODY:Y35:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y35:str:N" />"
							chname="细菌性角斑病3级" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y36" name="D912_BODY:Y36:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y36:str:N" />"
							chname="细菌性角斑病4级" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y37" name="D912_BODY:Y37:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y37:str:N" />"
							chname="细菌性角斑病病情指数" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y33+Y34*2+Y35*3+Y36*4)*100";gsjg[gsjg.length]="Y37";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y38" name="D912_BODY:Y38:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y38:str:N" />" chname="软腐病病株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y39" name="D912_BODY:Y39:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y39:str:N" />"
							chname="软腐病病株率（％）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y38/Y05*100";gsjg[gsjg.length]="Y39";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y40" name="D912_BODY:Y40:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y40:str:N" />" chname="病毒病病株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y41" name="D912_BODY:Y41:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y41:str:N" />"
							chname="病毒病病株率（％）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y40/Y05*100";gsjg[gsjg.length]="Y41";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y42" name="D912_BODY:Y42:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D912_BODY:Y42:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
				<td colspan=100 align="center">
					...
					type=button value="提交" id="btnSubmit" /> <%}else{if(shbz.equals("1")){%><input
					type=button value="增加" id="btnAddRow" />&nbsp;&nbsp;<input
					type=button value="删除" id="btnDel" />&nbsp;&nbsp;<input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D912_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width: ;height: ;font-size:12"
					value="<%=username%>" /></td>
				<td colspan=1 rowspan=1
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D912_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
