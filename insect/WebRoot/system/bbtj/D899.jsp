		...
		%><table
			...
			<tr>
				<td colspan=11 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>设施蔬菜虫害调查报表（基点）(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D899_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D899_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D899_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D899_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D899_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D899_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D899_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D899_BODY:Y02:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D899_BODY:Y02:str:S" />" chname="基地"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D899_BODY:Y03:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D899_BODY:Y03:str:S" />"
							chname="棚主姓名或棚室编号" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y04" other="chname='茬口及棚种类' nullable='no'"
								name="D899_BODY:Y04:str:S" datamember=" dsys11 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D899_BODY:Y05:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_SCZL' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D899_BODY:Y06:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D899_BODY:Y06:str:S" />" chname="品种"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D899_BODY:Y07:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D899_BODY:Y07:str:D" />" class="Wdate"
							onFocus="WdatePicker({skin:'whyGreen', maxDate: '%y-%M-%d' })" onkeyup="changeiput(this)" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D899_BODY:Y08:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D899_BODY:Y08:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D899_BODY:Y09:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_SCSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y10" other="zi='Y05' chname='害虫名称' nullable='no'"
								name="D899_BODY:Y10:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_SCCHZL' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D899_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D899_BODY:Y11:str:N" />" chname="调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D899_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D899_BODY:Y12:str:N" />" chname="虫株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D899_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D899_BODY:Y13:str:N" />" chname="虫株率（％）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y12/Y11*100";gsjg[gsjg.length]="Y13";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D899_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D899_BODY:Y14:str:N" />" chname="虫量（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D899_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D899_BODY:Y15:str:N" />"
							chname="百株虫量(头/百株)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y14/Y11*100";gsjg[gsjg.length]="Y15";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D899_BODY:Y16:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D899_BODY:Y16:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D899_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width: ;height: ;font-size:12"
					value="<%=username%>" /></td>
				<td colspan=1 rowspan=1
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D899_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
