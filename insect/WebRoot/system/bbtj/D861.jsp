		...
		%><table
			...
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>小麦叶锈病生长后期品种抗病性调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D861_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D861_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>作物品种</b></td>
					<td colspan=1 rowspan=1
					...
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>调查叶片数</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>发病叶片数</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>病叶率（%）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>抗性（反应型）</b></td>
					<td colspan=1 rowspan=1
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D861_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D861_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D861_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D861_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D861_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D861_BODY:Y02:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D861_BODY:Y02:str:S" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D861_BODY:Y03:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D861_BODY:Y03:str:N" />" chname="调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D861_BODY:Y04:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D861_BODY:Y04:str:N" />" chname="病株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D861_BODY:Y05:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D861_BODY:Y05:str:N" />" chname="病株率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y04/Y03*100";gsjg[gsjg.length]="Y05";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D861_BODY:Y06:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D861_BODY:Y06:str:N" />" chname="调查叶片数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D861_BODY:Y07:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D861_BODY:Y07:str:N" />" chname="发病叶片数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D861_BODY:Y08:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D861_BODY:Y08:str:N" />" chname="病叶率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y07/Y06*100";gsjg[gsjg.length]="Y08";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y09" other="chname='抗性（反应型）' nullable='no'"
								name="D861_BODY:Y09:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_XMKX' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D861_BODY:Y10:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D861_BODY:Y10:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D861_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D861_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
