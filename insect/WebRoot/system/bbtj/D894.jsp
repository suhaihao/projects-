		...
		%><table
			...
			<tr>
				<td colspan=8 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>一代玉米螟（条螟）田间卵量消长调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D894_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D894_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width: ;height: "
					value="<%=zt%>" /></td>
			</tr>
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width:90;height: "><b>调查株数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width:90;height: "><b>有卵株数</b></td>
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D894_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D894_BODY:DCRQ:D"
							style="width:86;height: ;font-size:12"
							value=" <mt:vlabel name="D894_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D894_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D894_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02" other="chname='寄主作物' nullable='no'"
								name="D894_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='BBYMMZW' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y03" other="chname='生育期' nullable='no'"
								name="D894_BODY:Y03:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_YMSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D894_BODY:Y04:N"
							style="width:90;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y04:str:N" />" chname="调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D894_BODY:Y05:N"
							style="width:90;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y05:str:N" />" chname="有卵株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D894_BODY:Y06:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y06:str:N" />"
							chname="正常卵块（块）玉米螟" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D894_BODY:Y14:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y14:str:N" />" chname="正常卵粒（粒）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D894_BODY:Y07:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y07:str:N" />"
							chname="寄生卵块（块）玉米螟" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D894_BODY:Y08:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y08:str:N" />"
							chname="孵化卵块（块）玉米螟" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D894_BODY:Y09:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y09:str:N" />"
							chname="干瘪脱落卵块（块）玉米螟" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D894_BODY:Y10:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y10:str:N" />" chname="卵块(块）条螟"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D894_BODY:Y11:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y11:str:N" />"
							chname="有效卵量合计（块）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y06+Y10";gsjg[gsjg.length]="Y11";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D894_BODY:Y12:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y12:str:N" />"
							chname="平均百株有效卵块(块/百株)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y11/Y04)*100";gsjg[gsjg.length]="Y12";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D894_BODY:Y13:S"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D894_BODY:Y13:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D894_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=rowspan=1><input type="hidden"
					name="D894_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
