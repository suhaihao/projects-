		...
		%><table
			...
			<tr>
				<td colspan=8 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>一代玉米螟化蛹、羽化进度调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D893_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D893_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>寄主种类</b></td>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>活虫数（头）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>死虫数（头）</b></td>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>活蛹数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>死蛹数（头）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>蛹壳（个）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>总活虫数</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>化蛹率（%）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>羽化率（%）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>备注</b></td>
				</tr>
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>1-3龄</b></td>
					<td colspan=1 rowspan=1
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D893_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D893_BODY:DCRQ:D"
							style="width:86;height: ;font-size:12"
							value=" <mt:vlabel name="D893_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D893_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D893_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02" other="chname='寄主种类' nullable='no'"
								name="D893_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='BBYMMZW' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D893_BODY:Y03:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y03:str:N" />"
							chname="1-3龄活虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D893_BODY:Y04:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y04:str:N" />"
							chname="4龄活虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D893_BODY:Y05:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y05:str:N" />"
							chname="5龄活虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D893_BODY:Y06:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y06:str:N" />"
							chname="合计活虫数（头）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y03+Y04+Y05";gsjg[gsjg.length]="Y06";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D893_BODY:Y07:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y07:str:N" />" chname="死虫数（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D893_BODY:Y08:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y08:str:N" />"
							chname="1级活蛹数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D893_BODY:Y09:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y09:str:N" />"
							chname="2级活蛹数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D893_BODY:Y10:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y10:str:N" />"
							chname="3级活蛹数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D893_BODY:Y11:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y11:str:N" />"
							chname="合计活蛹数（头）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y08+Y09+Y10";gsjg[gsjg.length]="Y11";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D893_BODY:Y12:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y12:str:N" />" chname="死蛹数（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D893_BODY:Y13:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y13:str:N" />" chname="蛹壳（个）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D893_BODY:Y14:N"
							style="width:45;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y14:str:N" />" chname="总活虫数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y06+Y11+Y13";gsjg[gsjg.length]="Y14";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D893_BODY:Y15:N"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y15:str:N" />" chname="化蛹率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y11+Y13)/(Y07+Y12+Y14)*100";gsjg[gsjg.length]="Y15";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D893_BODY:Y16:N"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y16:str:N" />" chname="羽化率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y13/(Y07+Y12+Y14)*100";gsjg[gsjg.length]="Y16";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y17" name="D893_BODY:Y17:S"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D893_BODY:Y17:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D893_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D893_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
