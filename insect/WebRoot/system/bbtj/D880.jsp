		...
		%><table
			...
			<tr>
				<td colspan=6 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>褐足角胸肖叶甲普查表(<%=rwsj%>)
				</b><br>
				<br></td>
			...
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D880_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D880_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>最高单株虫量（头）</b></td>
					<td colspan=1 rowspan=1
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D880_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D880_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D880_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D880_BODY:XZ:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usebm} and jc='2' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y01"
								other="onchange='xuanze(this)' fu='XZ' chname='调查地点' nullable='no'"
								name="D880_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02" other="chname='生育期' nullable='no'"
								name="D880_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_YMSYQ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D880_BODY:Y03:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D880_BODY:Y03:str:S" />" chname="品种"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D880_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D880_BODY:Y04:str:N" />" chname="调查株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D880_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D880_BODY:Y05:str:N" />" chname="虫株数"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D880_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D880_BODY:Y06:str:N" />" chname="总虫量（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D880_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D880_BODY:Y07:str:N" />"
							chname="最高单株虫量（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D880_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D880_BODY:Y08:str:N" />" chname="虫株率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y05/Y04*100";gsjg[gsjg.length]="Y08";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D880_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D880_BODY:Y09:str:N" />" chname="百株虫量（头）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y06/Y04*100";gsjg[gsjg.length]="Y09";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D880_BODY:Y10:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D880_BODY:Y10:str:N" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D880_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D880_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
