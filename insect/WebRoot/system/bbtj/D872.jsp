		...
		%><table
			...
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>三代粘虫田间幼虫密度调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D872_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D872_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D872_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D872_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D872_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D872_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D872_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y13" other="zi='Y02' chname='取样单位' nullable='no'"
								name="D872_BODY:Y13:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='N_NCQYDW' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y02"
								other="onchange='xuanze(this)' fu='Y13' chname='作物种类' nullable='no'"
								name="D872_BODY:Y02:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='BBNCTJ' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D872_BODY:Y03:N"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D872_BODY:Y03:str:N" />"
							chname="取样数(m2或株)" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D872_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D872_BODY:Y04:str:N" />"
							chname="一龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D872_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D872_BODY:Y05:str:N" />"
							chname="二龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D872_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D872_BODY:Y06:str:N" />"
							chname="三龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D872_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D872_BODY:Y07:str:N" />"
							chname="四龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D872_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D872_BODY:Y08:str:N" />"
							chname="五龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D872_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D872_BODY:Y09:str:N" />"
							chname="六龄幼虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D872_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D872_BODY:Y10:str:N" />"
							chname="合计幼虫数（头）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y04+Y05+Y06+Y07+Y08+Y09";gsjg[gsjg.length]="Y10";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D872_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D872_BODY:Y11:str:N" />"
							chname="幼虫密度(头/ 百株或m2)" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y10/Y03";gsjg[gsjg.length]="Y11";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D872_BODY:Y12:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D872_BODY:Y12:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D872_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D872_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
