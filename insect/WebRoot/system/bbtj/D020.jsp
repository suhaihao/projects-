...
<body>
	<%
		...
		try {
			String sql = "select * from D020 where jfid=" + jfid;
			...
			while (rsbody.next()) {
				...
				JYDCYQY = rsbody.getString("JYDCYQY")==null?"":rsbody.getString("JYDCYQY");
				GSYDMJ = rsbody.getString("GSYDMJ")==null?"":rsbody.getString("GSYDMJ");
				CYFBZWZL = rsbody.getString("CYFBZWZL")==null?"":rsbody.getString("CYFBZWZL");
				PJCKMD = rsbody.getString("PJCKMD")==null?"":rsbody.getString("PJCKMD");
				ZGCKMD = rsbody.getString("ZGCKMD")==null?"":rsbody.getString("ZGCKMD");
				ZGCKMDCXXD = rsbody.getString("ZGCKMDCXXD")==null?"":rsbody.getString("ZGCKMDCXXD");
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				<td colspan=5 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>二点委夜蛾越冬虫源调查统计表(<%=rwsj%>)
				</b><br> <br></td>
			</tr>
			<tr>
			...
			<tbody id="zg_head">
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>见越冬虫源区域（市和县名称）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>估算越冬面积（万亩）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>虫源分布作物种类</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>平均虫口密度（头/m2）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>最高虫口密度（头/m2）</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>最高虫口密度出现县点</b></td>
				</tr>
			</tbody>
			<tbody id="zg_body">
				 <tr>
					<td><input style="width: 100%;" name="JYDCYQY" type="text"
						value="<%=JYDCYQY%>" /></td>
					<td><input style="width: 100%;" name="GSYDMJ" type="text"
						value="<%=GSYDMJ%>" alertname="估算越冬面积必须为数字" datatype="number" /></td>
					<td><input style="width: 100%;" name="CYFBZWZL" type="text"
						value="<%=CYFBZWZL%>"  /></td>
					<td><input style="width: 100%;" name="PJCKMD" type="text"
						value="<%=PJCKMD%>" alertname="平均虫口密度必须为数字" datatype="number" /></td>
					<td><input style="width: 100%;" name="ZGCKMD" type="text"
						value="<%=ZGCKMD%>" alertname="最高虫口密度必须为数字" datatype="number" /></td>
					<td><input style="width: 100%;" name="ZGCKMDCXXD" type="text"
						value="<%=ZGCKMDCXXD%>"  /></td>
				</tr>
			</tbody>
			<tr>
	...
	<table border=0 cellpadding=0 cellspacing=0 align=center>
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_body">
				 <tr>
					<td><label><%=JYDCYQY%></label></td>
					<td><label><%=GSYDMJ%></label></td>
					<td><label><%=CYFBZWZL%></label></td>
					<td><label><%=PJCKMD%></label></td>
					<td><label><%=ZGCKMD%></label></td>
					<td><label><%=ZGCKMDCXXD%></label></td>
				</tr>
			</tbody>
			<tr>
				<td colspan=100 align="center">
