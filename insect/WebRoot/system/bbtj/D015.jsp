			...
			<tbody id="zg_body">
				 ...
				 <tr>
					...
					<td><input style="width: 100%;" name="CCCJQBLNZW" type="text"
						value="<%=CCCJQBLNZW%>" alertname="成虫始见期比历年早晚必须为数字" datatype="number" /></td>
