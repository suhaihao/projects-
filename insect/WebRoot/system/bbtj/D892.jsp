		...
		%><table
			...
			<tr>
				<td colspan=8 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>越冬代玉米螟化蛹、羽化进度调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D892_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D892_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>死幼虫数（头）</b></td>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>活蛹数（头）</b></td>
					<td colspan=1 rowspan=2
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D892_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D892_BODY:DCRQ:D"
							style="width:85;height: ;font-size:12"
							value=" <mt:vlabel name="D892_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y01" other="chname='寄主种类' nullable='no'"
								name="D892_BODY:Y01:str:S" datamember=" dsys11 "
								select=" jfcode,jfcodename "
								where=" jfsort='BBYMMZW' order by jfcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="XZ"
								other="onchange='xuanze(this)' fu='Y18' chname='乡镇' nullable='no'"
								name="D892_BODY:XZ:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usebm} and jc='2' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y18" other="zi='XZ' chname='调查地点' nullable='no'"
								name="D892_BODY:Y18:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D892_BODY:Y02:N"
							style="width:44;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y02:str:N" />"
							chname="1-3龄活虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D892_BODY:Y03:N"
							style="width:44;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y03:str:N" />"
							chname="4龄活虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D892_BODY:Y04:N"
							style="width:44;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y04:str:N" />"
							chname="5龄活虫数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D892_BODY:Y05:N"
							style="width:44;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y05:str:N" />" chname="合计总活虫数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y02+Y03+Y04";gsjg[gsjg.length]="Y05";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D892_BODY:Y06:N"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y06:str:N" />" chname="死幼虫数（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D892_BODY:Y07:N"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y07:str:N" />"
							chname="1级活蛹数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D892_BODY:Y08:N"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y08:str:N" />"
							chname="2级活蛹数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D892_BODY:Y09:N"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y09:str:N" />"
							chname="3级活蛹数（头）" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D892_BODY:Y10:N"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y10:str:N" />"
							chname="合计活蛹数（头）" nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y07+Y08+Y09";gsjg[gsjg.length]="Y10";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D892_BODY:Y11:N"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y11:str:N" />" chname="死蛹数（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D892_BODY:Y12:N"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y12:str:N" />" chname="蛹壳"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D892_BODY:Y13:N"
							style="width:60;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y13:str:N" />" chname="总活虫数"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y05+Y10+Y12";gsjg[gsjg.length]="Y13";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D892_BODY:Y14:N"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y14:str:N" />" chname="化蛹率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="(Y10+Y12)/(Y06+Y11+Y13)*100";gsjg[gsjg.length]="Y14";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D892_BODY:Y15:N"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y15:str:N" />" chname="羽化率（%）"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y12/(Y06+Y11+Y13)*100";gsjg[gsjg.length]="Y15";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D892_BODY:Y16:S"
							style="width:50;height: ;font-size:12"
							value="<mt:vlabel name="D892_BODY:Y16:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D892_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D892_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
