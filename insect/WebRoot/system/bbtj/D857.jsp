		...
		%><table
			...
			<tr>
				<td colspan=8 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>小麦吸浆虫剥穗查残虫表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D857_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D857_HEAD:ND:S" value="" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D857_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>土质及前茬</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>小麦品种</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>小麦抽穗期</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>穗被害情况</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>粒被害情况</b></td>
					<td colspan=3 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>幼虫数量（头）</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>损失率(%)</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>备注(防治情况)</b></td>
				</tr>
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>检查穗数</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>被害穗数</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>被害穗率(%)</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>检查粒数</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>被害粒数</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>被害粒率(%)</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>总虫数</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>平均百穗</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>最多单穗</b></td>
				</tr>
			</tbody>
			<tbody id="zg_body">
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D857_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D857_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D857_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="XZ" name="D857_BODY:XZ:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usebm} and jc='2' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								id="Y01" name="D857_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D857_BODY:Y02:S"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y02:str:S" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D857_BODY:Y03:S"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y03:str:S" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D857_BODY:Y04:S"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y04:str:S" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D857_BODY:Y05:N"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y05:str:N" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D857_BODY:Y06:N"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y06:str:N" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D857_BODY:Y07:N"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y07:str:N" />" />
						<script type="text/javascript">jsgs[jsgs.length]="Y06/Y05*100";gsjg[gsjg.length]="Y07";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D857_BODY:Y08:N"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y08:str:N" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D857_BODY:Y09:N"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y09:str:N" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D857_BODY:Y10:N"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y10:str:N" />" />
						<script type="text/javascript">jsgs[jsgs.length]="Y09/Y08*100";gsjg[gsjg.length]="Y10";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D857_BODY:Y11:N"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y11:str:N" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D857_BODY:Y12:N"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y12:str:N" />" />
						<script type="text/javascript">jsgs[jsgs.length]="Y11/Y05*100";gsjg[gsjg.length]="Y12";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D857_BODY:Y13:N"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y13:str:N" />" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D857_BODY:Y14:N"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y14:str:N" />" />
						<script type="text/javascript">jsgs[jsgs.length]="Y11/4/Y08*100";gsjg[gsjg.length]="Y14";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D857_BODY:Y15:S"
							style="width:70;height: ;font-size:12"
							value="<mt:vlabel name="D857_BODY:Y15:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D857_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:80;height: ;font-size:12"
					value="<%=time%>" /></td>
				<td colspan=1 rowspan=1
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D857_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
