		...
		%><table
			...
			<tr>
				<td colspan=6 rowspan=1
					style="text-align:center;font-size=30;width: ;height: "><b>主要地下害虫田间密度调查表(<%=rwsj%>)
				</b><br>
				<br></td>
			</tr>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D864_HEAD:BMBM:S" value="<%=userbmbm%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D864_HEAD:ZT:S" value="0" /><input type="text"
					readonly="readonly"
		...
		<table border=1 borderColorDark=black borderColorLight=white
			...
			<tbody id="zg_head">
				<tr>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>作物</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>前茬</b></td>
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>取样面积(m2)</b></td>
					...
					<td colspan=1 rowspan=2
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>蛴螬（头）</b></td>
					<td colspan=4 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>平均密度（头/
							m2）</b></td>
					<td colspan=1 rowspan=2
				...
				<tr>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>东方</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>华北</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>沟</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>细胸</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>蝼蛄</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>金针虫</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>蛴螬</b></td>
					<td colspan=1 rowspan=1
						style="word-break: break-all;text-align:center; font-size:12;width: ;height: "><b>合计</b></td>
				</tr>
			</tbody>
				...
				<mt:sheet pagesize="20">
					<tr onclick="focusTR(this)">
						<input name="delid" type="hidden"
							value="<mt:vlabel name="D864_BODY:JFDYID:str:S" />" />
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="DCRQ" name="D864_BODY:DCRQ:D"
							style="width:80;height: ;font-size:12"
							value=" <mt:vlabel name="D864_BODY:DCRQ:str:D" />" class="Wdate"
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D864_BODY:XZ:str:S" datamember=" dsys06 "
						...
						<td align=left style="height:25px" colspan=1 rowspan=1><mt:vselect
								...
								name="D864_BODY:Y01:str:S" datamember=" dsys06 "
								select=" jfregcode,jfregname "
								where=" ${usecun} and jc='3' and jfstate='1' order by jfregcode"></mt:vselect></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y02" name="D864_BODY:Y02:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y02:str:S" />" chname="作物"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y03" name="D864_BODY:Y03:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y03:str:S" />" chname="前茬"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y04" name="D864_BODY:Y04:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y04:str:N" />"
							chname="取样面积(m2)" nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y05" name="D864_BODY:Y05:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y05:str:N" />" chname="东方蝼蛄"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y06" name="D864_BODY:Y06:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y06:str:N" />" chname="华北蝼蛄"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y07" name="D864_BODY:Y07:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y07:str:N" />" chname="蝼蛄合计"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y05+Y06";gsjg[gsjg.length]="Y07";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y08" name="D864_BODY:Y08:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y08:str:N" />" chname="沟金针虫"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y09" name="D864_BODY:Y09:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y09:str:N" />" chname="细胸金针虫"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y10" name="D864_BODY:Y10:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y10:str:N" />" chname="金针虫合计"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y08+Y09";gsjg[gsjg.length]="Y10";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y11" name="D864_BODY:Y11:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y11:str:N" />" chname="蛴螬（头）"
							nullable="no" /></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y12" name="D864_BODY:Y12:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y12:str:N" />" chname="蝼蛄平均密度"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y07/Y04";gsjg[gsjg.length]="Y12";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y13" name="D864_BODY:Y13:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y13:str:N" />" chname="金针虫平均密度"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y10/Y04";gsjg[gsjg.length]="Y13";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y14" name="D864_BODY:Y14:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y14:str:N" />" chname="蛴螬平均密度"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y11/Y04";gsjg[gsjg.length]="Y14";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y15" name="D864_BODY:Y15:N"
							style="width:40;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y15:str:N" />" chname="合计平均密度"
							nullable="no" />
						<script type="text/javascript">jsgs[jsgs.length]="Y12+Y13+Y14";gsjg[gsjg.length]="Y15";</script></td>
						<td align=left style="height:25px" colspan=1 rowspan=1><input
							type="text" id="Y16" name="D864_BODY:Y16:S"
							style="width:80;height: ;font-size:12"
							value="<mt:vlabel name="D864_BODY:Y16:str:S" />" /></td>
					</tr>
				</mt:sheet>
			</tbody>
			<tr>
 ...
 %><input
		...
		<table border=0 cellpadding=0 cellspacing=0 align=center>
			<tr>
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D864_HEAD:LRRQ:D" value="<%=time%>" /><input type="text"
					readonly="readonly"
				...
				<td colspan=1 rowspan=1><input type="hidden"
					name="D864_HEAD:LRRY:S" value="<%=userid%>" /><input type="text"
					readonly="readonly"
					style="border:0;border-bottom:1px solid #000000;width:100;height: ;font-size:12"
					value="<%=username%>" /></td>
			</tr>
