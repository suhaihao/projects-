...
<jsp:include page="/header.jsp" flush="true">
	<jsp:param name="title" value="增加作物" />
</jsp:include>
<!-- start content -->
<div id="content">
	<!-- navigation -->
...
<tr>
  ...
  <td  width="400px"align="left">
    <input name="JFPLANTCODE" size="30"  chname="部门名称" nullable="no"/>
  </td>
</tr>
<tr>
  <td align="right" ><div class="cell-wrap">作物名称：</div></td>
  <td  width="400px"align="left">
    <input name="JFPLANTNAME" size="30"  chname="部门名称" nullable="no"/>
  </td>
</tr>
