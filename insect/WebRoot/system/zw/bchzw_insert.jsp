...
<tr>
  ...
  <td  width="400px"align="left">
    <%=bchmc%>
    <input name="JFPLANTCODE" type="hidden" value="<%=bchbm%>"/>
...
<tr id="qx" style="display: ">
  ...
  <td  width="400px"align="left">
        ...
        <mt:freeselect other="style='width:192px;margin:-2px'" name="JFINSECTCODE" datamember="dbch" select="JFINSECTCODE,JFINSECTNAME" where=" JFSTATE='1' order by JFINSECTNAME" >
        </mt:freeselect>
      </span>
  </td>
    <tr>
...
function f_save(){
       document.f1.action = "/insect/zwAction.do?ACT_TYPE=INSERT_ZW";
