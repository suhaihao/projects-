...
<%@page import="java.sql.PreparedStatement"%>
	<%
		...
		String sql = "delete from dbbzb_cx_tj where jfdbbzb_cx_id='" + dbbzb_cx_id + "'";
		ExecuteConnection ec = new ExecuteConnection();
		PreparedStatement pstmt = ec.con.prepareStatement(sql);		
		if (pstmt.executeUpdate() >= 0) {
			for(int i=0; jg_ids != null && i<jg_ids.length; i++){
				sql = "insert into dbbzb_cx_tj(jfid,JFDBBZB_CX_ID,JFDBBZB_JG_ID,JFOPERATION) values(sequ_dbbzb_cx_tj.nextval,'" 
