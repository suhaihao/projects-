...
<jsp:include page="/header.jsp" flush="true">
	<jsp:param name="title" value="增加病虫害类别" />
</jsp:include>
...
<tr>
  <td align="right" ><div class="cell-wrap">病虫害类别编码：</div></td>
  <td  width="400px"align="left">
       <input type="text" id="freeselect1" chname="部门编码" nullable="no"  name="bmbm" size="30">
  </td>
</tr>
<tr>
  <td align="right" ><div class="cell-wrap">病虫害类别名称：</div></td>
  <td  width="400px"align="left">
...
function f_save(){
       document.f1.action = "/insect/bchlbAction.do?ACT_TYPE=INSERT";
