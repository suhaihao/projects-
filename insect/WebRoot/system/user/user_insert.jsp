...
<jsp:include page="/header.jsp" flush="true">
	<jsp:param name="title" value="增加用户" />
</jsp:include>
...
<tr>
  ...
  <td  width="400px"align="left">
       <input type="text" id="freeselect1" chname="部门编码" nullable="no"  name="jfcode" size="30">
  </td>
</tr>
<tr>
  <td align="right" ><div class="cell-wrap">用户名称：</div></td>
  <td  width="400px"align="left">
    <input name="jfname" size="30"  chname="部门名称" nullable="no"/>
  </td>
</tr>
    <tr>
...
<tr>
  ...
  <td  width="400px"align="left">
    <input name="jfuserid" size="30"  chname="部门名称" nullable="no"/>
  </td>
    </tr>
<tr>
  <td align="right" ><div class="cell-wrap">密码：</div></td>
  <td  width="400px"align="left">
    <input name="jfpassword" size="30"  chname="部门名称" nullable="no"/>
  </td>
    </tr>
    <tr>
