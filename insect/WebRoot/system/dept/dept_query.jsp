...
<jsp:include page="/header.jsp" flush="true">
	<jsp:param name="title" value="部门查询" />
</jsp:include>
    ...
    <div class="layout grid-s5m0">
        <div class="layout-main">
            <div class="layout-wrap">
            	<div class="mod">
					<div class="mod-hd">
						<h3 class="mod-tit">部门查询</h3>
					</div>
					<div class="mod-bd">
		                <form name="f1" method="post" action="/insect/deptAction.do?ACT_TYPE=QUERY" target="result">
							<table class="w">
								<tr>
								
									<td class="tr" style="width:80px">
										<div class="cell-wrap">部门编码:</div>
									</td>
									<td style="width:100px">
										<input type="text" name="bmbm" size="10">
									</td>
									<td class="tr" style="width:80px">
										<div class="cell-wrap">部门名称:</div>
									</td>
									<td style="width:100px">
										<input type="text" name="bmmc" maxlength="100">
									</td>
									<td class="tr" style="width:80px">
										<div class="cell-wrap">部门属性:</div>
									</td>
									<td style="width:90px">
										<select name="bmsx">
				...
				<iframe id="result" name="result" style="width:100%;border:0px;" scrolling="no" onload="iFrameHeight()" src="/insect/deptAction.do?ACT_TYPE=QUERY"></iframe>
        	</div>
    	</div>
