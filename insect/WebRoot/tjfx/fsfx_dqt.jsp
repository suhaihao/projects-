...
<html>
  ...
  while (rsq.next())
  {
    sz="select sum(b."+zd+") from d898_body b,d898_head h where b.jfdyid=h.jfid and to_char(h.rwsj,'yyyy-mm-dd')>='"+cxsjstr+"' and to_char(h.rwsj,'yyyy-mm-dd')<='"+cxsjend+"'";
 ...
 {
   window.location="/insect/tjfx/fsfx_dqt.jsp?cxsjstr="+cxsjstr+"&cxsjend="+cxsjend+"&dbsjstr="+dbsjstr+"&dbsjend="+dbsjend+"&ssqyval="+ssqyval+"&fxdx="+fxdx+"&p=exp";
 }  
