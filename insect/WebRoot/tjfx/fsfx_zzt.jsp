...
<html>
  ...
  while (rsq.next())
  {
    sz="select round(sum(decode(sign(nvl(b."+zd+",0)),1,1,0))*100/count(*),2) from d898_body b,d898_head h where b.jfdyid=h.jfid and b."+zd+">0 and to_char(h.rwsj,'yyyy-mm-dd')>='"+cxsjstr+"' and to_char(h.rwsj,'yyyy-mm-dd')<='"+cxsjend+"'";
 ...
 {
   window.location="/insect/tjfx/fsfx_zzt.jsp?cxsjstr="+cxsjstr+"&cxsjend="+cxsjend+"&ssqyval="+ssqyval+"&p=exp&fxdx="+fxdx;
 }  
