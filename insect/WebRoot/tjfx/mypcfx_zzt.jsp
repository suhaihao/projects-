...
<html>
  ...
  are=are.substring(0,are.length()-1);
    ...
    %>
   <div style="width: 100%;margin-top: 10px;"><center><font size="5px" color="black"><b>虫田率变化分析</b></font></center></div>
   ...
   {
   %>
   <input class="btn" type="button" value="导出Excel" onclick="f_exp('<%=cxsjstr %>','<%=cxsjend %>','<%=ssqyval %>')"/>&nbsp;
   <%
   }
   %>
   </center>
