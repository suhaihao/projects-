...
<html>
  ...
  while (rsq.next())
  {
    sz="select sum(b."+zd+") from d903_body b,d903_head h where b.jfdyid=h.jfid and b.Y10='0001' and b.Y05='0101' and to_char(h.rwsj,'yyyy-mm-dd')>='"+cxsjstr+"' and to_char(h.rwsj,'yyyy-mm-dd')<='"+cxsjend+"'";
 ...
 {
   window.location="/insect/tjfx/fqhmbfx_dqt.jsp?cxsjstr="+cxsjstr+"&cxsjend="+cxsjend+"&dbsjstr="+dbsjstr+"&dbsjend="+dbsjend+"&ssqyval="+ssqyval+"&fxdx="+fxdx+"&p=exp";
 }  
