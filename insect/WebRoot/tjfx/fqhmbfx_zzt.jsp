...
<html>
  ...
  while (rsq.next())
  {          
    sz="select round(sum(decode(sign(nvl(b."+zd+",0)),1,1,0))*100/count(*),2) from d903_body b,d903_head h where b.jfdyid=h.jfid and b."+zd+">0 and b.Y10='0001' and b.Y05='0101' and to_char(h.rwsj,'yyyy-mm-dd')>='"+cxsjstr+"' and to_char(h.rwsj,'yyyy-mm-dd')<='"+cxsjend+"'";
  ...
  are=are.substring(0,are.length()-1);
    ...
    %>
   <div style="width: 100%;margin-top: 10px;"><center><font size="5px" color="black"><b>病田率变化分析</b></font></center></div>
 ...
 {
   window.location="/insect/tjfx/fqhmbfx_zzt.jsp?cxsjstr="+cxsjstr+"&cxsjend="+cxsjend+"&ssqyval="+ssqyval+"&p=exp&fxdx="+fxdx;
 }  
