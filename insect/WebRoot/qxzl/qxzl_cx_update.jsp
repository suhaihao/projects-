...
<span style="width:180px;border:1px solid #797a98">
	<mt:vselect other="style='width:192px;margin:-2px' disabled='disabled'" name="d:JFSTATIONCODE:str:s" datamember="dsys11" select="JFCODE,JFCODENAME" where=" jfsort='ZDBM' order by JFCODE" >
	</mt:vselect>
</span>
       </div>
  </td>
