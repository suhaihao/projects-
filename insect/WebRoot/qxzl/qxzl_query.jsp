        ...
        <div class="layout-main">
            <div class="layout-wrap">
            	<div class="mod">
					...
					<div class="mod-bd">
		                <form name="f1" method="post" action="/insect/qxzlAction.do?ACT_TYPE=QUERY" target="result">
							<table class="w" >
								<tr>
				...
				<script type="text/javascript">
					...
					function f_add(obj){
							var p = window.open("/insect/qxzl/qxzl_insert.jsp","newqxzl");
				}
					
				</script>
				<iframe id="result" name="result" style="width:100%;border:0px;" scrolling="no" onload="iFrameHeight()" src="/insect/qxzlAction.do?ACT_TYPE=QUERY"></iframe>
        	</div>
    	</div>
