...
public class BbhznyAction extends InitAction {
	...
	protected void actionQuery(ServletObject so) {
		...
		String sql = "select distinct dbbzb.jfid,dbbzb.jfcode,dbbzb.jftabname,f_get_mc('RYBM',dbbzb.jflister) rymc,to_char(dbbzb.jflistdate,'yyyy-mm-dd') lrrq,decode(dbbzb.jftabsort,'0','系统表','1','普查表','&nbsp;') bbzl from dbbzb where dbbzb.jfstate='1' and dbbzb.jflb like '03%' ";
