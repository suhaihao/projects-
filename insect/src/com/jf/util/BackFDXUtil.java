...
public class BackFDXUtil {
    ...
    public static void getRequest1(){
        ...
        Map params = new HashMap();//请求参数
            params.put("word",DEF_CHATSET);//需要检测的短信内容，需要UTF8 URLENCODE
    ...
    public static String getRequest2(String telephone,String name,String mc,String jb,String time){
        ...
        Map<String, Object> params = new HashMap<String, Object>();//请求参数
            ...
            params.put("tpl_id",26160);//短信模板ID，请参考个人中心短信模板设置
            params.put("tpl_value","#name#="+name+"&#mc#="+mc+"&#jb#="+jb+"&#time#="+time);//变量名和变量值对。如果你的变量名或者变量值中带有#&amp;=中的任意一个特殊符号，请先分别进行urlencode编码后再传递，&lt;a href=&quot;http://www.juhe.cn/news/index/id/50&quot; target=&quot;_blank&quot;&gt;详细说明&gt;&lt;/a&gt;
            params.put("key",APPKEY);//应用APPKEY(应用详细页查询)
