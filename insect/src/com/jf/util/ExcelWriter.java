 ...
 * </p>
 * 
 * @version $FileName: ExcelWriter.java $Date: 2013-6-25
 * @since 1.0
 * 
 */
...
public class ExcelWriter<T> {
	...
	public void exportExcel20031(String title, String[] headers,
	...
	public static void main(String[] args) throws Exception {
		ExcelWriter<ExcelBean> ew = new ExcelWriter<ExcelBean>();
		ExcelBean b1 = new ExcelBean("Jack", 27, new Date());
		ExcelBean b2 = new ExcelBean("Tom", 26, new Date());
		String title = "测试报表001";
		String[] headers = {"姓名", "年龄", "birth"};
		List<ExcelBean> dataset = new ArrayList<ExcelBean>();
		dataset.add(b1);
		dataset.add(b2);
		OutputStream out = new FileOutputStream("e:\\exp33.xls");
		//ew.exportExcel(title, headers, dataset, out, "2003");
		String[] data = {"Jack|28|2008-05-25", "Tom|26|2001-07-25|", "David|30|2010-11-25"};
		ew.exportExcel20031(title, headers, data, out, "20003");
	}
}
